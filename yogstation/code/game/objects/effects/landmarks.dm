...
/obj/effect/landmark/stationroom/box/engine
	template_names = list("Engine SM" = 50, "Engine TSM" = 0, "Engine Singulo And Tesla" = 50, "Engine TEG" = 0)
...
/obj/effect/landmark/stationroom/meta/engine
	template_names = list("Meta Singulo And Tesla" = 50, "Meta SM" = 50, "Meta TSM" = 0, "Meta TEG" = 0)
