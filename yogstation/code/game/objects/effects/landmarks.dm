...
/obj/effect/landmark/stationroom/box/engine
	template_names = list("Engine SM" = 90, "Engine TSM" = 10, "Engine Singulo And Tesla" = 0, "Engine TEG" = 0)
...
/obj/effect/landmark/stationroom/meta/engine
	template_names = list("Meta Singulo And Tesla" = 0, "Meta SM" = 90, "Meta TSM" = 10, "Meta TEG" = 0)
