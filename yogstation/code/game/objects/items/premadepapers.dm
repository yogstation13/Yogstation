...
/obj/item/paper/redd
	name = "ERROR"
	info = "You shouldn't have this."

/obj/item/paper/redd/general_request_form
...
//atmospheric technician spacesuit request form
/obj/item/paper/redd/atmos_tech_spacesuit_form
	name = "Atmos Spacesuit Request Form (Form NT-A14)"
	fields = 1
	info = "I, <b><span class=\"paper_field\"></span></b>, request a <b>space suit</b> from <b>EVA</b> in the event of an atmospheric emergency requiring one.<br><b>Signed,<br>Atmospheric Technician<br></b>"

//complaint form
/obj/item/paper/redd/complaint_form
...
/obj/item/paper/redd/cyborg_request_form
...
/obj/item/paper/redd/hopaccessrequestform
	name = "HoP Access Request Form (Form NT-022)"
	fields = 2
	info = "<b>Name: </b><span class=\"paper_field\"></span><br><b>Accesses Requested: </b><span class=\"paper_field\"></span><br><b>Reason:</b> "

//HOP job request form
/obj/item/paper/redd/hop_job_change_form
	name = "HoP Job Change Form (Form NT-059)"
	fields = 3
	info = "<b>Name: </b><span class=\"paper_field\"></span><br><b>Current Job: </b><span class=\"paper_field\"></span><br><b>Requested Job:</b> <span class=\"paper_field\"></span><br><b>Request for Change:</b> "

//RD request form
/obj/item/paper/redd/rd_form
...
//Mech request form
/obj/item/paper/redd/mech_form
	name = "R&D Mech Request Form (Form SCI-9)"
	fields = 4
	info = "<b>Name: </b><span class=\"paper_field\"></span><br><b>Job: </b><span class=\"paper_field\"></span><br><b>Requested Mech: </b><span class=\"paper_field\"></span><br><b>Reason: </b><span class=\"paper_field\"></span><br>Signed: "
//end yogs code