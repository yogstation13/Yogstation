...
/datum/game_mode/infiltration/generate_report() //make this less shit
	return "Reports show that the Syndicate is rounding up it's elite agents, possibly for a raid on a yogscast-controlled station. Keep an eye out for unusual people."
