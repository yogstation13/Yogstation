...
/obj/structure/closet/crate/battleroyale/PopulateContents()
	...
	if(prob(50)) //Weapons crate
		...
		if(prob(30)) //Common
			...
			new /obj/item/ammo_container/c38(src)
			new /obj/item/clothing/suit/armor/vest(src)
			return
		else if(prob(30))
			new /obj/item/ammo_container/box/c9mm(src)
			new /obj/item/ammo_container/box/c10mm(src)
			new /obj/item/ammo_container/box/c45(src)
			new /obj/item/clothing/suit/armor/vest(src)
			...
			new /obj/item/ammo_container/box/a40mm(src)
			...
			new /obj/item/ammo_container/no_direct/n762(src)
			new /obj/item/ammo_container/box/foambox/riot
