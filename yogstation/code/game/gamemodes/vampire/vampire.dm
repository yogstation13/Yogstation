...
/datum/game_mode/vampire
	...
	protected_jobs = list("Divisional Lead", "City Administrator", "Head of Personnel", "Research Director", "Chief Engineer", "Chief Medical Officer", "Civil Protection Officer", "Chaplain", "Detective", "Warden", "Brig Physician") //Added Brig Physician
	required_players = 15
	required_enemies = 1
