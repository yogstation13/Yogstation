...
/datum/biome/jungleland/barren_rocks
	...
	fauna_density = 0.5 
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/random = 33,/mob/living/simple_animal/hostile/asteroid/goliath/beast = 33,/mob/living/simple_animal/hostile/asteroid/goldgrub = 25,/mob/living/simple_animal/hostile/asteroid/yog_jungle/skin_twister = 1, /mob/living/simple_animal/hostile/asteroid/marrowweaver = 7)
...
/datum/biome/jungleland/dry_swamp
	...
	loose_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast = 39,/mob/living/simple_animal/hostile/asteroid/goldgrub = 31,/mob/living/simple_animal/hostile/asteroid/yog_jungle/meduracha = 8,/mob/living/simple_animal/hostile/asteroid/yog_jungle/skin_twister = 1,/mob/living/simple_animal/hostile/asteroid/wasp/mosquito = 13, /mob/living/simple_animal/hostile/asteroid/yog_jungle/emeraldspider = 8)
	fauna_density = 0.4
...
/datum/biome/jungleland/toxic_pit
	...
	dense_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/yog_jungle/blobby = 20,/mob/living/simple_animal/hostile/asteroid/yog_jungle/meduracha = 50,/mob/living/simple_animal/hostile/asteroid/yog_jungle/skin_twister = 2,/mob/living/simple_animal/hostile/asteroid/wasp/mosquito = 46, /mob/living/simple_animal/hostile/asteroid/yog_jungle/emeraldspider = 2)
	fauna_density = 0.7
	spawn_fauna_on_closed = TRUE
...
/datum/biome/jungleland/dying_forest
	...
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/magmawing = 39,/mob/living/simple_animal/hostile/asteroid/yog_jungle/corrupted_dryad = 55,/mob/living/simple_animal/hostile/asteroid/yog_jungle/skin_twister = 1,/mob/living/simple_animal/hostile/asteroid/wasp/mosquito = 5)
	fauna_density = 0.8
...
/datum/biome/jungleland/jungle
	...
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/yog_jungle/dryad = 65 ,/mob/living/simple_animal/hostile/asteroid/yog_jungle/skin_twister = 1,/mob/living/simple_animal/hostile/asteroid/wasp/mosquito = 10, /mob/living/simple_animal/hostile/asteroid/wasp/yellowjacket = 10, /mob/living/simple_animal/hostile/asteroid/yog_jungle/emeraldspider = 14)
	fauna_density = 0.65
