...
/datum/antagonist/vampire/greet()
	...
	to_chat(owner, "<font color='red' size='4'>Hit someone in the head with harm intent to start sucking their blood. However, only blood from living, non-vampiric creatures is usable!</font>")
