...
/datum/design/pod_armor_gold
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron=5000,/datum/material/glass=2500,/datum/material/plasma=7500,/datum/material/uranium=10000)
	departmental_flags = DEPARTMENTAL_FLAG_ALL
...
/datum/design/pod_gun_laser
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron=10000,/datum/material/glass=5000,/datum/material/uranium=1000,/datum/material/silver=2000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_ka
	...
	id = "pod_ka"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 5000, /datum/material/silver = 2000, /datum/material/uranium = 2000, /datum/material/diamond = 2000)
...
/datum/design/pod_adv_plasma_cutter
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 5000, /datum/material/silver = 4000, /datum/material/uranium = 4000, /datum/material/diamond = 4000)
