...
/datum/design/pod_core
	...
	materials = list(/datum/material/iron=5000, /datum/material/uranium=1000, MAT_PLASMA=5000)
...
/datum/design/pod_armor_civ
	...
	id = "podarmor_civ"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron=15000,/datum/material/glass=5000,MAT_PLASMA=10000)
...
/datum/design/pod_armor_industrial
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron=15000,/datum/material/glass=5000,MAT_PLASMA=10000,MAT_DIAMOND=5000,MAT_SILVER=7500)
...
/datum/design/pod_armor_gold
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron=5000,/datum/material/glass=2500,MAT_PLASMA=7500,MAT_GOLD=10000)
	departmental_flags = DEPARTMENTAL_FLAG_ALL
...
/datum/design/pod_gun_bdisabler
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron = 15000,MAT_PLASMA=2000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_gun_laser
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron=10000,/datum/material/glass=5000,MAT_GOLD=1000,MAT_SILVER=2000)
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/pod_ka_basic
	...
	id = "pod_ka_basic"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 5000, MAT_SILVER = 2000, /datum/material/uranium = 2000)
...
/datum/design/pod_ka
	...
	id = "pod_ka"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 5000, MAT_SILVER = 2000, MAT_GOLD = 2000, MAT_DIAMOND = 2000)
...
/datum/design/pod_adv_plasma_cutter
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 10000, /datum/material/glass = 5000, MAT_SILVER = 4000, MAT_GOLD = 4000, MAT_DIAMOND = 4000)
...
/datum/design/lockbuster
	...
	category = list("Spacepod Designs")
	materials = list(/datum/material/iron = 15000, MAT_DIAMOND=2500) //it IS a drill!
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY
