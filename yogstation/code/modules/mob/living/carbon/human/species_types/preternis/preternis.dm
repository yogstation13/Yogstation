...
/datum/species/preternis
	...
	armor = 20 //Made of plasteel - hard to dent, hard to melt, on par with clockwork golems and zombies
	coldmod = 0.8 //Computers like cold, but fleshy bits (and your lungs) don't
	heatmod = 1.75 //Plasteel is a bad insulator, wear something to protect your insides
