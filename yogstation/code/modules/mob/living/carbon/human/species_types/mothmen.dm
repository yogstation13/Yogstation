/datum/species/moth
	var/MothLightRange = 10 //In what radius shall moths look for lights to fly at?
...
/datum/species/moth/spec_life(mob/living/carbon/human/H)
	. = ..()
	MothLightRange = initial(MothLightRange)
	MothLightProb = initial(MothLightProb)
	var/retarded = H.getBrainLoss()
	MothLightProb += 2+retarded*0.3 //So there's always a slight chance.
	MothLightRange += 2+retarded*0.1
