...
/obj/structure/lavaland/ivymen/Initialize()
	.=..()
...
/obj/structure/lavaland/ivymen/deconstruct(disassembled)
...
/obj/structure/lavaland/ivymen/proc/consume()
...
/obj/structure/lavaland/ash_walker/proc/spawn_mob()
	if(meat_counter >= IVYMEN_SPAWN_THRESHOLD)
		new /obj/effect/mob_spawn/human/ivymen(get_step(loc, pick(GLOB.alldirs)), ashies)
