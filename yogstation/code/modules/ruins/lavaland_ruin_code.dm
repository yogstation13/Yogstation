...
/obj/effect/mob_spawn/human/gasstation_clerk
	...
	flavour_text = "You are a Gas Station Clerk, the gas station you worked most of your life in was moved to some hellhole in the middle of nowhere for some reason, you are to try to make the best of the situation and make as much money as possible from any locals or passerbys you may encounter. Feel free to explore around the planet and find things to sell to potential customers but do not leave the place unless the gas station is somehow completely destroyed, If someone is trying to break in or is trying to steal your products you have the right to use any means necessary to stop them."
	id_job = "Clerk"
	l_pocket = /obj/item/flashlight/seclite
