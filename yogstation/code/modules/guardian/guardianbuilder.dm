...
/datum/guardianbuilder/proc/spawn_guardian(mob/living/user)
	...
	var/list/mob/dead/observer/candidates = debug_mode ? list(user) : pollGhostCandidates("Do you want to play as the [mob_name] of [user.real_name]?", ROLE_LAVALAND, null, FALSE, 100, POLL_IGNORE_HOLOPARASITE)
