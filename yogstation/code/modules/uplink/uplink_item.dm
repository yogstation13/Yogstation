...
/datum/uplink_item/race_restricted/xeno_organ_kit
	...
	desc = "A kit containing some organs that were... \"donated\" by your ancestors. Contains an autosurgen, plasma vessel, resin spinner, an acid gland, and a neurotoxin gland."
	cost = 15
