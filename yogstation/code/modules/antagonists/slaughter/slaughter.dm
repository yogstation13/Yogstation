...
/mob/living/simple_animal/slaughter/laughter/Initialize()
	..()
	var/datum/component/demonic/scary = GetComponent(/datum/component/crawl/blood/demonic)
	if(scary)
...
/mob/living/simple_animal/slaughter/laughter/proc/release_friends()
	var/datum/component/hilarious/bloodcrawl = GetComponent(/datum/component/crawl/blood/demonic/hilarious)
