/client/proc/mentor_follow(mob/living/M)
	...
	to_chat(GLOB.admins, "<span class='mentor'>[span_prefix("MENTOR:")] <EM>[key_name(usr)]</EM> is now following <EM>[key_name(M)]</span>", confidential=TRUE)
...
/client/proc/mentor_unfollow()
	...
	if(mentor_datum)
		to_chat(GLOB.admins, "<span class='mentor'>[span_prefix("MENTOR:")] <EM>[key_name(usr)]</EM> is no longer following <EM>[key_name(mentor_datum.following)]</span>", confidential=TRUE)
