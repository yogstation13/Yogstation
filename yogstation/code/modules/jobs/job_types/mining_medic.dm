/datum/job/miningmedic
	...
	base_access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_CARGO, ACCESS_MATERIALS, ACCESS_MECH_MINING, ACCESS_MECH_MEDICAL)
