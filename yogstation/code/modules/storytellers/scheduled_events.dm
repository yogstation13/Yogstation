...
/datum/scheduled_event/proc/get_href_actions()
	...
	if(round_started)
		return "<a href='byond://?src=[REF(src)];action=force_now'>Force Now</a> <a href='byond://?src=[REF(src)];action=reschedule'>Reschedule</a> <a href='byond://?src=[REF(src)];action=cancel'>Cancel</a> <a href='byond://?src=[REF(src)];action=refund'>Refund</a></td>"
	else
