...
/obj/item/pod_parts/armor/security
	...
	desc = "Tough military-grade pod armor, meant for use by the yogscast military and it's sub-divisons for space combat."
	pod_icon_state = "pod_mil"
	pod_desc = "An armed security spacepod with reinforced armor plating brandishing the yogscast Military insignia"
	pod_integrity = 350
