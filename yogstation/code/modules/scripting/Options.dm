...
*/
		...
		var/list/binary_operators=list(	"==" = /node/expression/operator/binary/Equal, 			   "!="	= /node/expression/operator/binary/NotEqual,
													...
													"`"  = /node/expression/operator/binary/Bitwior,  		"+" 	= /node/expression/operator/binary/Add,
													...
													"|=" = /node/expression/operator/binary/Assign/BitwiseOr,					 	 "`=" = /node/expression/operator/binary/Assign/Bitwior,
