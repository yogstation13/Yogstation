...
/obj/item/paper/crumpled/bloody/knew_too_much
	name = "bloody note"
	info = "<b>#m not go#n# t#  mak# i##<br>\
			<center>D##T T##ST #E##TC##M T#EY A#EN# W## #H#Y #A# TH## A#E<br>\
			T#INK<br>WH# D## W# #IG #H#S FA# DO#N??-</b>"
	infolang = /datum/language/common
