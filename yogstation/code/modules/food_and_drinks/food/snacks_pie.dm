/obj/item/reagent_containers/food/snacks/pie/buttcinnpie
	...
	slices_num = 5
	bonus_reagents = list("nutriment" = 1, "vitamin" = 5, /datum/reagent/consumable/cinnamon = 1)
...
/obj/item/reagent_containers/food/snacks/buttcinnpieslice
	...
	list_reagents = list("nutriment" = 5, /datum/reagent/consumable/cinnamon = 5, "sugar" = 5, "vitamin" = 3)
	tastes = list("cinnamon" = 1, "determination" = 1)