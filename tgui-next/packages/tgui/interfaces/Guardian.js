...
export const Guardian = (props) => {
  ...
  return (
    <Fragment>
      ...
      <Tabs>
        <Tabs.Tab key="General" label="General">
        ...
        <Tabs.Tab key="stats" label="Stats">
          <LabeledList>
            {data.ratedskills.map((skill) => (
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    act(ref, "set", { name: skill.name, level: 5 })
                  }
                />
                <Button
                  content="B"
                  ...
                  onClick={() =>
                    act(ref, "set", { name: skill.name, level: 4 })
                  }
                />
                <Button
                  content="C"
                  ...
                  onClick={() =>
                    act(ref, "set", { name: skill.name, level: 3 })
                  }
                />
                <Button
                  content="D"
                  ...
                  onClick={() =>
                    act(ref, "set", { name: skill.name, level: 2 })
                  }
                />
                <Button
                  content="F"
                  ...
                  onClick={() =>
                    act(ref, "set", { name: skill.name, level: 1 })
                  }
                />
              </LabeledList.Item>
            ))}
        ...
        <Tabs.Tab key="ability_major" label="Major Ability">
          {data.abilities_major.map((ability) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  act(ref, "ability_major", { path: ability.path })
                }
              />
            </LabeledList.Item>
          ))}
        </Tabs.Tab>
        <Tabs.Tab key="ability_minor" label="Minor Abilities">
          {data.abilities_minor.map((ability) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() =>
                  act(ref, "ability_minor", { path: ability.path })
                }
              />
            </LabeledList.Item>
          ))}
        </Tabs.Tab>
        <Tabs.Tab key="create" label="Create">
