...
export const ShuttleManipulator = (props) => {
  ...
  return (
    <Tabs>
      ...
      <Tabs.Tab key="templates" label="Templates">
        {() => (
          <Section>
            <Tabs>
              {map((template, templateId) => {
                ...
                return (
                  <Tabs.Tab key={templateId} label={template.port_id}>
      ...
      <Tabs.Tab key="modification" label="Modification">
        <Section>
          {selected ? (
            <Fragment>
                  ...
                  <LabeledList>
                    ...
                    >
                      ...
                      {!!existingShuttle.timer && (
                        <Fragment>({existingShuttle.timeleft})</Fragment>
                      )}
                    </LabeledList.Item>
                  </LabeledList>
                </Section>
