...
/datum/controller/subsystem/job/proc/FindOccupationCandidates(datum/job/job, level, flag)
	...
	for(var/mob/dead/new_player/player in unassigned)
		...
		if(((job.title in GLOB.command_positions) || (job.title in GLOB.nonhuman_positions)) && ((player.client.prefs.yogtoggles & QUIET_ROUND || player.client.prefs.job_preferences["Tourist"] == JP_HIGH)))
