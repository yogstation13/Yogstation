...
#error Your version of BYOND is too new to compile this project. Download version 515.1606 at www.byond.com/download/build/515/515.1606_byond.exe
#endif
...
#else
/// Call by name proc reference, checks if the proc exists on this type
#define PROC_REF(X) (nameof(.proc/##X))
/// Call by name proc reference, checks if the proc exists on given type
