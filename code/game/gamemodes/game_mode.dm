...
/datum/game_mode/proc/send_intercept()
	...
	priority_announce("A summary has been copied and printed to all communications consoles.", "Enemy communication intercepted. Security level elevated. <br> [generate_station_trait_report()]", ANNOUNCER_INTERCEPT)
