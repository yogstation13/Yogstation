...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Security Officer", "Warden", "Detective", "AI", "Cyborg", "Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer", "Shaft Miner", "Mining Medic", "Brig Physician", "Quartermaster") //Yogs: Added Brig Physician, QM is department head
	required_jobs = list(list("Captain"=1),list("Head of Personnel"=1),list("Head of Security"=1),list("Chief Engineer"=1),list("Research Director"=1),list("Chief Medical Officer"=1),list("Chief Medical Officer"=1),list("Quartermaster"=1)) //Any head present
	required_players = 30
	required_enemies = 2
