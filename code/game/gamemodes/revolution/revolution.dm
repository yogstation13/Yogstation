...
/datum/game_mode/revolution
	...
	restricted_jobs = list("Civil Protection Officer", "Warden", "Detective", "AI", "Cyborg", "City Administrator", "Head of Personnel", "Divisional Lead", "Chief Engineer", "Research Director", "Chief Medical Officer", "Shaft Miner", "Mining Medic", "Brig Physician", "Synthetic") //Yogs: Added Brig Physician
	required_jobs = list(list("City Administrator"=1),list("Head of Personnel"=1),list("Divisional Lead"=1),list("Chief Engineer"=1),list("Research Director"=1),list("Chief Medical Officer"=1)) //Any head present
	required_players = 25
	required_enemies = 2
