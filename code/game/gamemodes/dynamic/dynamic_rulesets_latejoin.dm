...
/datum/dynamic_ruleset/latejoin/provocateur
	...
	restricted_roles = list("AI", "Cyborg", "Civil Protection Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Synthetic")
	enemy_roles = list("AI", "Cyborg", "Civil Protection Officer","Detective","Head of Security", "Captain", "Warden")
