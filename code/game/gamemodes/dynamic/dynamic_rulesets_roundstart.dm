...
/datum/dynamic_ruleset/roundstart/wizard
	...
	restricted_roles = list("Divisional Lead", "District Administrator") // Just to be sure that a wizard getting picked won't ever imply a District Administrator or HoS not getting drafted
	required_candidates = 1
	weight = 2
	cost = 20
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("Chaplain","AI", "Cyborg", "Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "District Administrator", "Labor Lead", "Research Director", "Chief Engineer", "Chief Medical Officer", "Brig Physician", "Synthetic")
...
/datum/dynamic_ruleset/roundstart/infiltration
	...
	minimum_required_age = 14
	restricted_roles = list("Divisional Lead", "District Administrator")
	required_candidates = 5
	weight = 4
	cost = 18
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("Civil Protection Officer", "Warden", "Detective", "AI", "Cyborg", "District Administrator", "Labor Lead", "Divisional Lead", "Chief Engineer", "Research Director", "Chief Medical Officer", "Shaft Miner", "Mining Medic", "Brig Physician", "Synthetic")
...
/datum/dynamic_ruleset/roundstart/clockcult
	...
	protected_roles = list("AI", "Cyborg", "Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "District Administrator", "Brig Physician")
	restricted_roles = list("Chaplain", "District Administrator", "Synthetic")
...
/datum/dynamic_ruleset/roundstart/devil
	...
	restricted_roles = list("Lawyer", "Curator", "Chaplain", "Divisional Lead", "District Administrator", "AI", "Synthetic")
	required_candidates = 1
	weight = 1
	cost = 60
	flags = LONE_RULESET
...
/datum/dynamic_ruleset/roundstart/darkspawn //i don't entirely know how dynamic works, i hope i've set this up correctly
	...
	protected_roles = list("Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "District Administrator", "Labor Lead", "Research Director", "Chief Engineer", "Chief Medical Officer", "Brig Physician")
	restricted_roles = list("AI", "Cyborg", "Synthetic")
	minimum_players = 25
	required_candidates = 2
