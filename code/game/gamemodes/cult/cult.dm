...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Civil Protection Officer", "Warden", "Detective", "Divisional Lead", "City Administrator", "Head of Personnel", "Research Director", "Chief Engineer", "Chief Medical Officer", "Brig Physician", "Synthetic") //Yogs: Added Brig Physician
	protected_jobs = list()
	required_players = 24
	required_enemies = 4
