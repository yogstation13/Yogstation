...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Research Director", "Chief Engineer", "Chief Medical Officer","Prisoner", "Brig Physician") //Yogs: Added Brig Physician
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
