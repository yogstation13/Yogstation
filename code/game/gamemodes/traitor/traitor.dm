...
/datum/game_mode/traitor
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Brig Physician", "Prisoner") //YOGS -  added the hop and brig physician
	required_players = 0
	required_enemies = 1
