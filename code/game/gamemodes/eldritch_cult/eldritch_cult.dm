/datum/game_mode/heretics
	...
	protected_jobs = list("Chaplain","Civil Protection Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Research Director", "Chief Engineer", "Chief Medical Officer", "Brig Physician") //Yogs: Added Brig Physician
