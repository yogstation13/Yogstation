/atom/movable
	...
	var/moving_diagonally = FALSE //0: not doing a diagonal move. TRUE and 2: doing the first/second step of the diagonal move
...
//movement_dir == FALSE when stopping or any dir when trying to move
