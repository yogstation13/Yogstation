/atom/movable
	...
	var/anchored = FALSE
	var/spacemove_backup = FALSE // if this is something mobs can use to push off of and move through space (fringe case of moving off of non dense objects you can pass through)
