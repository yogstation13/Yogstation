...
/obj/machinery/decontamination_unit
	...
	desc = "This is a more advanced version of the industrial suit storage unit developed by the NT science and engineering team. It is capable of removing organic radiation as well as contaminated equipment. Can store up to 1000 items."
