...
/obj/machinery/recharger/attack_hand(mob/user)
	...
	if(charging)
		charging.update_appearance(updates = ALL)
...
/obj/machinery/recharger/update_overlays()	//we have an update_appearance(updates = ALL) in addition to the stuff in process to make it feel a tiny bit snappier.
	. = ..()
	if(stat & (NOPOWER|BROKEN) || !anchored)
		return
