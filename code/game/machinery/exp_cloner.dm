...
/obj/machinery/clonepod/experimental/growclone(clonename, ui, mutation_index, makeup, mindref, last_, datum/species/mrace, list/features, factions, list/quirks, datum/bank_account/insurance)
	if(panel_open)
		return NONE
	if(mess || attempting)
		return NONE
