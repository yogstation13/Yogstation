...
/obj/machinery/autolathe/ui_data(mob/user) // All the data the ui will need
	...
	for(var/v in stored_research.researched_designs)
		...
		if(ispath(D.build_path, /obj/item/stack))
			var/max_multiplier = min(D.maxstack, D.materials[/datum/material/iron] ? round(materials.get_material_amount(/datum/material/iron)/D.materials[/datum/material/iron]):INFINITY,D.materials[/datum/material/glass]?round(materials.get_material_amount(/datum/material/glass)/D.materials[/datum/material/glass]):INFINITY)
...
/obj/machinery/autolathe/proc/make_item(datum/design/D, multiplier)
	...
	var/metal_cost = request.materials[/datum/material/iron]
	var/glass_cost = request.materials[/datum/material/glass]
