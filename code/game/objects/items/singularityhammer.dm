...
/obj/item/twohanded/singularityhammer/update_appearance(updates = ALL)  //Currently only here to fuck with the on-mob icons.
...
/obj/item/twohanded/mjollnir/update_appearance(updates = ALL)  //Currently only here to fuck with the on-mob icons.
