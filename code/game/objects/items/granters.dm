...
/obj/item/book/granter/crafting_recipe/weapons
	...
	crafting_recipe_types = list(/datum/crafting_recipe/baseball_bat, /datum/crafting_recipe/lance, /datum/crafting_recipe/makeshiftlasrifle)	icon_state = "bookCrafting"
	oneuse = TRUE
