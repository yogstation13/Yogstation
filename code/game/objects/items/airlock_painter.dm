...
/obj/item/airlock_scanner				//yogs start -- i know i should be in it's own file but i can't brain when it commes to yogstation.dmi
	name = "airlock scaner"
	...
	flags_1 = CONDUCT_1
	item_flags = NOBLUDGEON
	slot_flags = ITEM_SLOT_BELT			//yogs end
