/obj/item/paper/guides/antag/antinoblium_guide
	...
	<li>yogscast safety controls will announce the destabilization of the crystal. Your identity will likely be compromised, but nothing can be done about the crystal.</li>\
	</ul>"
