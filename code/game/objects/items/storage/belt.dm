...
/obj/item/storage/belt/utility/ComponentInitialize(mapload)
	. = ..()
...
/obj/item/storage/belt/utility/makeshift/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/belt/medical/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/belt/security/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
	STR.max_combined_w_class = 18
...
/obj/item/storage/belt/security/chief/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 7
...
/obj/item/storage/belt/security/webbing/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 7
	STR.max_combined_w_class = 21
...
/obj/item/storage/belt/mining/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 8
	STR.max_w_class = WEIGHT_CLASS_BULKY
...
/obj/item/storage/belt/mining/primitive/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
...
/obj/item/storage/belt/soulstone/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
	STR.set_holdable(list(
...
/obj/item/storage/belt/champion/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 1
	STR.set_holdable(list(
...
/obj/item/storage/belt/military/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/belt/military/snack/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
	STR.max_w_class = WEIGHT_CLASS_SMALL
...
/obj/item/storage/belt/admin/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 1000
...
/obj/item/storage/belt/grenade/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 30
...
/obj/item/storage/belt/wands/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
	STR.set_holdable(list(
...
/obj/item/storage/belt/janitor/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 6
...
/obj/item/storage/belt/bandolier/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 24
	STR.max_combined_w_class = 24
...
/obj/item/storage/belt/holster/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 3
	STR.max_w_class = WEIGHT_CLASS_NORMAL
...
/obj/item/storage/belt/holster/syndicate/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 4
...
/obj/item/storage/belt/quiver/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 20
...
/obj/item/storage/belt/quiver/returning/holding/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 50
...
/obj/item/storage/belt/quiver/anomaly/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/belt/quiver/admin/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/belt/fannypack/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 3
	STR.max_w_class = WEIGHT_CLASS_SMALL
...
/obj/item/storage/belt/sabre/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
	STR.max_items = 1
