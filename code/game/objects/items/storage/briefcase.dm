/obj/item/storage/briefcase
	name = "briefcase"
	desc = "Despite how old it is, it still looks pretty good."
...
/obj/item/storage/briefcase/sniperbundle
	desc = "Its label reads \"genuine hardened District Administrator leather\", but suspiciously has no other tags or branding. Smells like L'Air du Temps."
	force = 10
