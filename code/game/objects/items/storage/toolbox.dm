...
/obj/item/storage/toolbox/syndicate/ComponentInitialize(mapload)
	. = ..()
...
/obj/item/storage/toolbox/brass/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/toolbox/artistic/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
