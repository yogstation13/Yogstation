...
/obj/item/storage/secure/ComponentInitialize(mapload)
	. = ..()
...
/obj/item/storage/secure/briefcase/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
...
/obj/item/storage/secure/safe/ComponentInitialize(mapload)
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage)
