...
/obj/item/melee/transforming/energy/sword
	name = "energy sword"
	desc = "A powerful energy-based hardlight sword that is easily stored when not in use. You can see 'May the force be within you' carved on the side of the handle."
	icon_state = "sword0"
