...
/obj/item/melee/sabre
	...
	var/parrying = FALSE
	var/parry_cd = 0
	var/parry_frames = 15 //a weapon designed for parrying
	
/obj/item/melee/sabre/proc/stop_parrying()
	if(parrying)
		parrying = FALSE
	
/obj/item/melee/sabre/attack_self(mob/user)
...
/obj/item/melee/sabre/IsReflect()
	return (parrying)
