...
/obj/item/melee/spear/grey_tide
	...
	desc = "Recovered from the aftermath of a revolt aboard Defence Outpost Theta Aegis, in which a seemingly endless tide of Assistants caused heavy casualities among Nanotrasen military forces."
	force = 15
