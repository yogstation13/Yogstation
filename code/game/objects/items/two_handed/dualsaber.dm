...
/obj/item/melee/dualsaber/Initialize(mapload)
	...
	AddComponent(/datum/component/cleave_attack, arc_size=360, requires_wielded=TRUE, cleave_effect=/obj/effect/temp_visual/dir_setting/firing_effect/sweep_attack/full_circle) // lol, lmao even
