...
GLOBAL_LIST_INIT(leather_recipes, list ( \
	new/datum/stack_recipe("axe scabbard", /obj/item/storage/belt/sabre/leather/axe, 6), \
	...
	new/datum/stack_recipe("leather sheath", /obj/item/storage/belt/sabre/leather, 8),
