...
GLOBAL_LIST_INIT(runed_metal_recipes, list ( \
	new/datum/stack_recipe("altar", /obj/structure/destructible/cult/talisman, 6, time = 40, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("archives", /obj/structure/destructible/cult/tome, 6, time = 40, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("forge", /obj/structure/destructible/cult/forge, 7, time = 60, one_per_turf = TRUE, on_floor = TRUE), \
