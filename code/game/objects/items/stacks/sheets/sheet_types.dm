...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe("scrubber", /obj/machinery/portable_atmospherics/scrubber, 10, time = 15, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("huge scrubber", /obj/machinery/portable_atmospherics/scrubber/huge, 20, time = 20, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
