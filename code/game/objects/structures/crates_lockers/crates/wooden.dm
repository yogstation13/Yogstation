...
/obj/structure/closet/crate/wooden/ashwalker/PopulateContents()
	. = ..()
	new	/obj/item/clothing/under/tribal/chestwrap(src)
	new	/obj/item/clothing/under/tribal/chestwrap(src)
	new	/obj/item/clothing/under/tribal/ash_robe(src)
	new /obj/item/clothing/under/tribal/ash_robe(src)
	new /obj/item/clothing/under/tribal/ash_robe(src)
	new /obj/item/clothing/under/tribal/ash_robe/young(src)
	new /obj/item/clothing/under/tribal/ash_robe/young(src)
	new /obj/item/clothing/under/tribal/ash_robe/hunter(src)
	new /obj/item/clothing/under/tribal/ash_robe/hunter(src)
	new /obj/item/clothing/under/tribal/ash_robe/chief(src)
	new /obj/item/clothing/under/tribal/ash_robe/shaman(src)
...
/obj/structure/closet/crate/wooden/ashwalker/extra/PopulateContents()
	. = ..()
	new	/obj/item/clothing/under/tribal/raider_leather(src)
	new	/obj/item/clothing/under/tribal(src)
	new	/obj/item/clothing/under/tribal/ash_robe/tunic(src)
	new	/obj/item/clothing/under/tribal/ash_robe/dress(src)
