...
/obj/item/paper/guides/jobs/medical/morgue
	...
	info = "<font size='2'>Since this station's medbay never seems to fail to be staffed by the mindless monkeys meant for genetics experiments, \
		...
		but keep it away from the kitchen and go yell at the union doctors.</font><BR><BR>- CentCom medical inspector"
...
/obj/structure/tray/morgue/CanAStarPass(ID, dir, caller)
	. = !density
	if(ismovable(caller))
