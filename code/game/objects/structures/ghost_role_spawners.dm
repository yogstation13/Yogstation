...
/obj/effect/mob_spawn/human/doctor/alive/lavaland
	...
	flavour_text = "<span class='What...?</span><b> Where are you? Where are the others? This is still the animal hospital - you should know, you've been an intern here for weeks - but \
	...
	everyone? Where did they go? What happened to the hospital? And is that <i>smoke</i> you smell? You need to find someone else. Maybe they can tell you what happened."
