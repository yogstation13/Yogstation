...
/obj/structure/sign/yogscast
	name = "\improper yogscast Logo"
	desc = "A sign with the yogscast Logo on it. Glory to yogscast!"
	icon_state = "yogscast"

/obj/structure/sign/logo
	name = "yogscast logo"
	desc = "The yogscast corporate logo."
	icon_state = "yogscast_sign1"
