...
/obj/item
	...
	var/heat_protection = FALSE //flags which determine which body parts are protected from heat. Use the HEAD, CHEST, GROIN, etc. flags. See setup.dm
	var/cold_protection = FALSE //flags which determine which body parts are protected from cold. Use the HEAD, CHEST, GROIN, etc. flags. See setup.dm
	...
	var/armour_penetration = FALSE //percentage of armour effectiveness to remove
	var/list/allowed = null //suit storage stuff.
	var/equip_delay_self = FALSE //In deciseconds, how long an item takes to equip; counts only for normal clothing slots, not pockets etc.
	...
	var/flags_cover = FALSE //for flags such as GLASSESCOVERSEYES
	var/heat = 0
	...
	var/block_chance = 0
	var/hit_reaction_chance = FALSE //If you want to have something unrelated to blocking/armour piercing etc. Maybe not needed, but trying to think ahead/allow more freedom
	var/reach = TRUE //In tiles, how far this weapon can reach; TRUE for adjacent, which is default
