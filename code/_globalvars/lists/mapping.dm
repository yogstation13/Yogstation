...
GLOBAL_LIST_INIT(megafauna_spawn_list, list(
	...
	/mob/living/simple_animal/hostile/megafauna/colossus = 6,
	/mob/living/simple_animal/hostile/megafauna/dragon = 6,
	/mob/living/simple_animal/hostile/megafauna/stalwart = 6,
))
