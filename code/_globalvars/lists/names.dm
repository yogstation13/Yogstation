...
GLOBAL_LIST_INIT(bubblegum_first_names, world.file2list("strings/names/bubble1.txt"))
GLOBAL_LIST_INIT(bubblegum_last_names, world.file2list("strings/names/bubble2.txt"))
GLOBAL_LIST_INIT(dragon_first_names, world.file2list("strings/names/drake1.txt"))
GLOBAL_LIST_INIT(dragon_last_names, world.file2list("strings/names/drake2.txt"))
