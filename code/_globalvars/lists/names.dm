...
GLOBAL_LIST_INIT(melting_first_names, world.file2list("strings/names/melting_first.txt"))
GLOBAL_LIST_INIT(melting_last_names, world.file2list("strings/names/melting_last.txt"))
