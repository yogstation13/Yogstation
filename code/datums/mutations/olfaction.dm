#define TRACKING_SCENT			(1<<1)
#define TRACKING_BLOOD			(1<<2)
#define TRACKING_HIDDENPRINTS	(1<<3)
...
/datum/mutation/human/olfaction
	...
	var/datum/action/cooldown/olfaction/acquire_scent/smelling
...
/datum/action/cooldown/olfaction
...
/datum/action/cooldown/olfaction/acquire_scent/blood
