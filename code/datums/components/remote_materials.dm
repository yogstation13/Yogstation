...
/datum/component/remote_materials/Initialize(mapload, category, mapload, allow_standalone = TRUE, force_connect = FALSE)
	if (!isatom(parent))
...
/datum/component/remote_materials/proc/LateInitialize(mapload)
