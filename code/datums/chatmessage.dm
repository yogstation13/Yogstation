...
/**
  ...
  * * sat_shift - A value between FALSE and TRUE that will be multiplied against the saturation
  * * lum_shift - A value between FALSE and TRUE that will be multiplied against the luminescence
  */
