...
/datum/brain_trauma/special/imaginary_friend/mrat/proc/get_ghost()
	set waitfor = FALSE
...
/mob/camera/imaginary_friend/mrat
	...
	var/datum/action/innate/mrat_leave/join

/mob/camera/imaginary_friend/mrat/proc/greet()
...
/mob/camera/imaginary_friend/mrat/proc/setup_friend()
	var/gender = NEUTER
	real_name = src.ckey
	name = real_name
