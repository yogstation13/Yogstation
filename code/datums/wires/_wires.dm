...
/datum/wires
	...
	/// The display name for the wire set shown in station blueprints. Not shown in blueprints if randomize is TRUE or it's an itemYCwouldn't know about (Explosives/Nuke). Also used in the hacking interface.
