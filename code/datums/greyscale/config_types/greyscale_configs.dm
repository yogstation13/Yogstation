...
/datum/greyscale_config/pressure_tank/stripe
	name = "Striped Pressure Tank"
	json_config = 'code/datums/greyscale/json_configs/pressure_tank_stripe.json'
...
/datum/greyscale_config/carp_mega
	name = "Megacarp"
	icon_file = 'icons/mob/broadMobs.dmi'
...
/datum/greyscale_config/sneakers_worn
	name = "Worn Sneakers"
	icon_file = 'icons/mob/clothing/feet/feet.dmi'
...
/datum/greyscale_config/sombrero
	name = "Sombrero"
	icon_file = 'icons/obj/clothing/sombrero.dmi'
