...
/datum/symptom/heal/conversion
	...
	desc = "The virus rapidly consumes nutrients in the blood to heal wounds."
	stealth = 0
	resistance = -2
	stage_speed = 2
	transmittable = -2
	level = 1
	passive_message = "<span class='notice'>You feel your cuts warm up before quickly vanishing.</span>"
	var/Toxin_damage = FALSE
	threshold_desc = "<b>Stealth 2:</b> Less warning.<br>\
					  <b>Stage Speed 7:</b> Increases healing speed."
...
/datum/symptom/heal/conversion/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	if(M.nutrition > 0)
		M.nutrition = max(M.nutrition - 20, 0)
