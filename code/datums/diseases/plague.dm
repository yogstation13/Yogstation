...
/datum/disease/tuberculosis/stage_act()
	...
	switch(stage)
		...
		if(4)
			...
			if(prob(2))
				to_chat(affected_mob, span_danger("You can barelly breath!"))
				affected_mob.adjustOxyLoss(5)
				affected_mob.emote("gasp")
			if(prob(10))
				to_chat(affected_mob, span_danger("You can't breath!"))
		...
		if(5)
			...
			if(prob(6))
				to_chat(affected_mob, span_danger("You don't feel air in your lungs!"))
