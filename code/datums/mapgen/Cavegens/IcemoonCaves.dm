/datum/map_generator/cave_generator/icemoon
	...
	weighted_mob_spawn_list = list(/mob/living/simple_animal/hostile/mining/wolf = 50, /obj/structure/spawner/ice_moon = 3, \
						  /mob/living/simple_animal/hostile/mining/polarbear = 30, /obj/structure/spawner/ice_moon/polarbear = 3, \
						  /mob/living/simple_animal/hostile/mining/hivelord/legion/snow = 50, 
						  /mob/living/simple_animal/hostile/mining/marrowweaver/ice = 30,
						  /mob/living/simple_animal/hostile/mining/goldgrub = 10,
						  /mob/living/simple_animal/hostile/mining/ambusher = 10)
...
/datum/map_generator/cave_generator/icemoon/surface
	...
	weighted_mob_spawn_list = list(/mob/living/simple_animal/hostile/mining/wolf = 50, /obj/structure/spawner/ice_moon = 3, \
						  ...
						  /mob/living/simple_animal/hostile/mining/marrowweaver/ice = 30,
						  /mob/living/simple_animal/hostile/mining/goldgrub = 10,
						  /mob/living/simple_animal/hostile/mining/ambusher = 2)
...
/datum/map_generator/cave_generator/icemoon/deep
	...
	mob_spawn_list = list(/mob/living/simple_animal/hostile/mining/ice_demon = 50, /obj/structure/spawner/ice_moon/demonic_portal = 3, \
						  /mob/living/simple_animal/hostile/mining/ice_whelp = 30, /obj/structure/spawner/ice_moon/demonic_portal/ice_whelp = 3, \
						  /mob/living/simple_animal/hostile/mining/hivelord/legion/snow = 50, /obj/structure/spawner/ice_moon/demonic_portal/snowlegion = 3, \
						  SPAWN_MEGAFAUNA = 2)
