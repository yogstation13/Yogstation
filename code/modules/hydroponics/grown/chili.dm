...
/obj/item/seeds/chili
	...
	reagents_add = list(/datum/reagent/consumable/capsaicin = 0.25, /datum/reagent/consumable/nutriment = 0.04)
...
/obj/item/seeds/chili/ice
	...
	rarity = 20
	mutatelist = list()
	reagents_add = list(/datum/reagent/consumable/frostoil = 0.25, /datum/reagent/consumable/nutriment = 0.02)
