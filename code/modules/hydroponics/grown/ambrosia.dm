...
/obj/item/seeds/ambrosia
	...
	reagents_add = list(/datum/reagent/drug/space_drugs = 0.15, /datum/reagent/medicine/c2/libital = 0.1, /datum/reagent/medicine/c2/aiuri = 0.1, /datum/reagent/consumable/nutriment/vitamin = 0.04, /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/toxin = 0.1)
