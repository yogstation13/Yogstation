...
/obj/item/seeds/cannabis
	...
	reagents_add = list(/datum/reagent/cbd = 0.15, /datum/reagent/thc = 0.15) 
...
/obj/item/seeds/cannabis/rainbow
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/cbd = 0.15, /datum/reagent/thc = 0.15, /datum/reagent/toxin/mindbreaker = 0.15)
	rarity = 40
...
/obj/item/seeds/cannabis/death
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/toxin/cyanide = 0.35, /datum/reagent/cbd = 0.15, /datum/reagent/thc = 0.15)
	rarity = 40
...
/obj/item/seeds/cannabis/white
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/medicine/omnizine = 0.35, /datum/reagent/cbd = 0.15, /datum/reagent/thc = 0.15)
	rarity = 40
