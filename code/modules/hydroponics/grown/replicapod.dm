...
/obj/item/seeds/replicapod/harvest(mob/user) //now that one is fun -- Urist
	...
	if(make_podman)	//all conditions met!
		...
		to_chat(podman, span_notice("You do not remember your , how you died, or who killed you. <a href='https://forums.yogstation.net/help/rules/#rule-1_6'>See rule 1.6</a>.")) //yogs
