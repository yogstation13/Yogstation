...
/obj/item/seeds/soya
	...
	reagents_add = list( /datum/reagent/consumable/nutriment = 0.05, /datum/reagent/consumable/cooking_oil = 0.03) //Vegetable oil!
...
/obj/item/seeds/soya/koi
	...
	potency = 10
	mutatelist = list()
	reagents_add = list(/datum/reagent/toxin/carpotoxin = 0.1, /datum/reagent/consumable/nutriment = 0.05)
	rarity = 20
