...
/datum/mapGeneratorModule/splatterLayer/lavalandMonsters
	spawnableTurfs = list()
	spawnableAtoms = list(/mob/living/simple_animal/hostile/mining/goliath/beast = 10,
	/mob/living/simple_animal/hostile/mining/hivelord/legion = 10,
	/mob/living/simple_animal/hostile/mining/basilisk/watcher = 10,
	/mob/living/simple_animal/hostile/mining/basilisk/watcher/magmawing = 10)
