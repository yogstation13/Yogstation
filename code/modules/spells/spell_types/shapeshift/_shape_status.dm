...
/datum/status_effect/shapechange_mob/on_apply()
	...
	caster_mob.apply_status_effect(/datum/status_effect/incapacitating/stasis, STASIS_SHAPECHANGE_EFFECT)
...
/datum/status_effect/shapechange_mob/proc/on_wabbajacked(mob/living/source, randomized)
	...
	revealed_mob.Paralyse(10 SECONDS, ignore_canstun = TRUE)
...
/datum/status_effect/shapechange_mob/proc/restore_caster(kill_caster_after = FALSE)
	...
	caster_mob.remove_status_effect(/datum/status_effect/incapacitating/stasis, STASIS_SHAPECHANGE_EFFECT)
...
/datum/status_effect/shapechange_mob/proc/on_caster_death(datum/source, gibbed)
	...
	if(gibbed)
		INVOKE_ASYNC(owner, TYPE_PROC_REF(/mob/living, gib))
