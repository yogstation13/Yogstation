...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/spicy
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/capsaicin = 2)
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/teriyaki
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/soysauce = 2)
	tastes = list("meat" = 2, "dough" = 2, "soy sauce" = 2)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/pizza
	...
	icon_state = "donkpocketpizza"
	bonus_reagents = list(/datum/reagent/nutriment/vitamin = 1)
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/tomatojuice = 2)
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/honk
	...
	icon_state = "donkpocketbanana"
	bonus_reagents = list(/datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/laughter = 3)
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/banana = 4, /datum/reagent/consumable/laughter = 3)
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/berry
	...
	icon_state = "donkpocketberry"
	bonus_reagents = list(/datum/reagent/nutriment/vitamin = 1)
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/consumable/berryjuice = 3)
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/gondola
	...
	icon_state = "donkpocketgondola"
	bonus_reagents = list(/datum/reagent/nutriment/vitamin = 1, /datum/reagent/tranquility = 5)
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/tranquility = 5)
	tastes = list("meat" = 2, "dough" = 2, "inner peace" = 1)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/donkpocket/warm/gondola/fake
	...
	desc = "A more market-friendly version of the infamous Gondolapocket. Donk Co certifies no gondolas were harmed in the making of this donk pocket."
	icon_state = "donkpocketgondola"
	bonus_reagents = list(/datum/reagent/nutriment/vitamin = 1, /datum/reagent/pax = 5)
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/nutriment/vitamin = 1, /datum/reagent/pax = 15)
	tastes = list("meat" = 2, "dough" = 2, "inner peace" = 1)
	foodtype = GRAIN | MEAT
