...
/datum/admins/proc/ban_panel(player_key, player_ip, player_cid, role, duration = 1440, applies_to_admins, reason, edit_id, page, admin_key)
	...
	if(edit_id)
		...
		var/list/long_job_lists = list("Civilian" = GLOB.original_civilian_positions,
									"Ghost and Other Roles" = list(ROLE_BRAINWASHED, ROLE_SQUAD, ROLE_DRONE, ROLE_FUGITIVE, ROLE_HOLOPARASITE, ROLE_HORROR, ROLE_LAVALAND, ROLE_MIND_TRANSFER, ROLE_POSIBRAIN, ROLE_SENTIENCE, ROLE_MOUSE, ROLE_GOLEM),
