...
/obj/item/organ/lungs/ghetto
	...
	desc = "A pair of oxygen tanks which have been attached to a modular (oxygen) reciever. They are incapable of supplying air, but can work as a replacement for lungs."
	icon_state = "lungs_g"
