...
/obj/item/autosurgeon/welding_eyes
	uses = 1
	starting_organ = /obj/item/organ/eyes/robotic/shield
...
/obj/item/paper/guides/antag/augmentation_kit
	info = "How to properly install the augmentation kit:<br>\
	<ul>\
	<li>Take out the five limb autosurgeons. Use each one individually.</li>\
	<li>Take out the three autosurgeons. Use each one individually.</li>\
	<li>Finally, use the implanter.</li>\
	</ul>"
