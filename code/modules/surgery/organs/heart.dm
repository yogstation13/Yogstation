...
/obj/item/organ/heart/nanite
	name = "Nanite heart"
	desc = "A specialized heart constructed from nanites that helps coordinate nanites allowing them to regenerate quicker and store themselfs in the body without any ill effects. Caution this organ will fail without nanites to sustain itself!"
	icon_state = "heart-c"
	synthetic = TRUE
	var/nanite_boost = 2
