...
/datum/surgery_step/heal
	...
	var/brutehealing = 0
	var/burnhealing = 0
	var/missinghpbonus = FALSE //heals an extra point of damager per X missing damage of type (burn damage for burn healing, brute for brute). Smaller Number = More Healing!
