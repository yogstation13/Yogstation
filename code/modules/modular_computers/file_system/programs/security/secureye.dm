...
/datum/computer_file/program/secureye
	...
	usage_flags = PROGRAM_CONSOLE | PROGRAM_LAPTOP |PROGRAM_STATIONARY| PROGRAM_INTEGRATED // Probably not a good idea to let borgs use this, though im curious how it will pan out
	size = 10
