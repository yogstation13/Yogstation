...
/datum/computer_file/program/chatclient/ui_act(action, params)
	...
	var/datum/ntnet_conversation/channel = SSmodular_computers.station_network.get_chat_channel_by_id(active_channel)
	var/authed = FALSE
	...
	switch(action)
		...
		if("PRG_joinchannel")
			...
			channel = SSmodular_computers.station_network.get_chat_channel_by_id(new_target)
		...
		if("PRG_toggleadmin")
			...
			if(can_run(user, TRUE, ACCESS_NETWORK))
				for(var/C in SSmodular_computers.station_network.chat_channels)
...
/datum/computer_file/program/chatclient/ui_data(mob/user)
	if(!SSmodular_computers.station_network || !SSmodular_computers.station_network.chat_channels)
		return list()
