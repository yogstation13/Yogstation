/obj/item/gun/energy/ionrifle
	name = "ion rifle"
	desc = "Invented in 2506 to quell attacks from SELF aligned IPCs, the Ion Rifle is a man-portable anti-armor weapon designed to disable mechanical threats at range."
	icon_state = "ionrifle"
