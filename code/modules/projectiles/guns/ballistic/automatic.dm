...
/obj/item/gun/ballistic/automatic/l6_saw
	...
	desc = "A heavily modified 7.12x82mm light machine gun featuring 1 round burst for harder shooting, designated 'L6 SAW'. Has 'Aussec Armoury - 2531' engraved on the receiver below the designation."
	icon_state = "l6"
