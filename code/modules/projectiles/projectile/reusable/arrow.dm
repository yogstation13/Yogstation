...
/obj/projectile/bullet/reusable/arrow/on_hit(atom/target, blocked = FALSE)
	...
	if(ismegafauna(L) || istype(L, /mob/living/simple_animal/hostile/mining) || istype(L, /mob/living/simple_animal/hostile/mining/yog_jungle) || istype(L, /mob/living/simple_animal/hostile/tar))
