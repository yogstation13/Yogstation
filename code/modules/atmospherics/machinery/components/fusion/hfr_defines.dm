...
#define FUSION_MOLE_THRESHOLD_HFR 25
///Used to reduce the gas_power to a more useful amount
#define INSTABILITY_GAS_POWER_FACTOR_HFR 0.003
///Used to calculate the toroidal_size for the instability
#define TOROID_VOLUME_BREAKEVEN_HFR 1000
...
#define HFR_RADIATION_FALLOFF 1000
