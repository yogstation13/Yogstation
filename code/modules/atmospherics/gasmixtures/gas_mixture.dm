...
/datum/gas_mixture
	...
	var/list/analyser_results //used for analyser feedback - not initialized until its used
...
/datum/gas_mixture/proc/set_analyser_results(instability)
	if(!analyser_results)
		analyser_results = new
	analyser_results["fusion"] = instability
