...
/obj/item/clothing/head/helmet/space/hardsuit/powerarmor_advanced
	...
	armor = list(MELEE = 50, BULLET = 10, LASER = 25, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 0, ACID = 10)
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	resistance_flags = FIRE_PROOF | LAVA_PROOF | ACID_PROOF

/obj/item/clothing/suit/space/hardsuit/powerarmor_advanced
	name = "X-01 power armor"
	desc = "A suit of X-01 power armor. It looks pretty impressive and threatening. The suit storage hook is sturdy enough to hold a Crusher!"
