...
/obj/item/clothing/head/det_hat/evil
	...
	desc = "A suspicious black fedora with a red band. It can be activated in-hand to extend or retract razor blades which cause significant damage when thrown."
