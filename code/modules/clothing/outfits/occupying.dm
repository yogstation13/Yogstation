...
/obj/item/storage/belt/military/occupying_officer/ComponentInitialize(mapload) // Occupying Officer
	. = ..()
...
/obj/item/storage/belt/military/occupying_commander/ComponentInitialize(mapload) // Occupying force Commander
	. = ..()
	new /obj/item/ammo_box/magazine/wt550m9/wtr(src)
	new /obj/item/ammo_box/magazine/wt550m9/wtr(src)
	new /obj/item/reagent_containers/autoinjector/medipen(src)
...
/obj/item/storage/belt/military/occupying_heavy/ComponentInitialize(mapload) // Occupying Riot Officer
	. = ..()
