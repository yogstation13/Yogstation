...
/obj/item/storage/belt/military/amber/ComponentInitialize(mapload) // Amber Soldier
	. = ..()
...
/obj/item/storage/belt/military/amber_commander/ComponentInitialize(mapload) // Amber Commander
	. = ..()
	new /obj/item/ammo_box/magazine/recharge(src)
	new /obj/item/ammo_box/magazine/recharge(src)
	new /obj/item/reagent_containers/autoinjector/medipen(src)
...
/obj/item/storage/belt/military/amber_medic/ComponentInitialize(mapload) // Amber Medic
	. = ..()
	new /obj/item/ammo_box/magazine/recharge(src)
