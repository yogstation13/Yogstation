...
/obj/item/storage/belt/military/amber/Initialize() // Amber Soldier
	. = ..()
...
/obj/item/storage/belt/military/amber_commander/Initialize() // Amber Commander
	. = ..()
	new /obj/item/ammo_box/magazine/recharge(src)
	new /obj/item/ammo_box/magazine/recharge(src)
	new /obj/item/reagent_containers/autoinjector/medipen(src)
...
/obj/item/storage/belt/military/amber_medic/Initialize() // Amber Medic
	. = ..()
	new /obj/item/ammo_box/magazine/recharge(src)
