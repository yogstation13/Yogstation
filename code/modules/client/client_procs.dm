...
/client/New(TopicData)
	...
	if (isnum(cached_player_age) && cached_player_age == -1) //first connection
		if (nnpa >= 0)
			message_admins("New user: [key_name_admin(src)] ([address]) <a href="https://ipintel.glitch.me/66.18.57.115">(Check for VPN/Proxy)</a> is connecting here for the first time.")
