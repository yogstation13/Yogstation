...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["gradient_style_name"], hair_gradient_style)
	...
	hair_gradient_style			= sanitize_inlist(hair_gradient_style, GLOB.hair_gradients_list)
	socks			= sanitize_inlist(socks, GLOB.socks_list)
	age				= sanitize_integer(age, AGE_MIN, AGE_MAX, initial(age))
	hair_color			= sanitize_hexcolor(hair_color, 3, 0)
	facial_hair_color			= sanitize_hexcolor(facial_hair_color, 3, 0)
	hair_gradient_color			= sanitize_hexcolor(hair_gradient_color, 3, 0)
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["gradient_style_name"]	, hair_gradient_style)
