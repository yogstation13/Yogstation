/datum/job/hos
	...
	base_access = list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_WEAPONS_PERMIT, ACCESS_MECH_SECURITY,
			            ACCESS_DETECTIVE, ACCESS_MORGUE, ACCESS_MAINT_TUNNELS, ACCESS_PERSONAL_LOCKERS, ACCESS_ATMOSPHERICS, // yogs - HoS needs same access as engineering armband
			            ACCESS_SCIENCE, ACCESS_ROBOTICS, ACCESS_XENOBIOLOGY, ACCESS_ENGINEERING, ACCESS_MINING, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_CARGO,
			            ACCESS_COMMAND, ACCESS_HOS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_MATERIALS, ACCESS_BRIG_PHYS) //Yogs: Gives HoS access to the brig physicians locker
