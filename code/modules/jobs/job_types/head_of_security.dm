...
/datum/outfit/job/hos
	...
	backpack_contents = list(/obj/item/melee/baton/loaded=1, /obj/item/modular_computer/tablet/preset/advanced/command=1) //yogs - removed departmental budget ID //come here often?
