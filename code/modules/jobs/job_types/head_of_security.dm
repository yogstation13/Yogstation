/datum/job/hos
	...
	base_access = list(ACCESS_COMMAND, ACCESS_SECURITY, ACCESS_HOS, ACCESS_SEC_BASIC,
					...
					ACCESS_XENOBIOLOGY, ACCESS_ROBOTICS, ACCESS_CARGO, ACCESS_CARGO_BAY,
					ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MAINT_TUNNELS, ACCESS_EVA,
					ACCESS_PERSONAL_LOCKERS, ACCESS_VAULT, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH)
