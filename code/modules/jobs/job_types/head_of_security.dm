/datum/job/hos
	...
	base_access = list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_WEAPONS_PERMIT, ACCESS_MECH_SECURITY,
			            ...
			            ACCESS_COMMAND, ACCESS_HOS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_BRIG_PHYS) //Yogs: Gives HoS access to the brig physicians locker
