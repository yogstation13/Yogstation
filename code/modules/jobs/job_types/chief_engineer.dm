/datum/job/chief_engineer
	...
	base_access = list(ACCESS_ENGINEERING, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_SECURE_TECH, ACCESS_MAINT_TUNNELS,
			            ACCESS_EXTERNAL_AIRLOCKS, ACCESS_ATMOSPHERICS, ACCESS_EVA, ACCESS_TCOMMS, ACCESS_TCOMMS_ADMIN,
			            ACCESS_COMMAND, ACCESS_CONSTRUCTION, ACCESS_SEC_BASIC, ACCESS_AI_SAT, ACCESS_MECH_ENGINE,
			            ACCESS_CE, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_MATERIALS)
