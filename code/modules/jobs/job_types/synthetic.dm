GLOBAL_LIST_INIT(synthetic_base_access, list(
	ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_DETECTIVE,
	ACCESS_MEDICAL, ACCESS_GENETICS, ACCESS_MORGUE, ACCESS_RD, ACCESS_SCIENCE,
	ACCESS_TOXINS, ACCESS_TOXINS_STORAGE, ACCESS_CHEMISTRY, ACCESS_ENGINEERING, ACCESS_ENGINE_EQUIP, ACCESS_MAINT_TUNNELS,
	ACCESS_EXTERNAL_AIRLOCKS, ACCESS_CHANGE_IDS, ACCESS_AI_MASTER,
	ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_COMMAND, ACCESS_CAPTAIN, ACCESS_PERSONAL_LOCKERS,
	ACCESS_TECH_STORAGE, ACCESS_SECURE_TECH, ACCESS_CHAPEL_OFFICE, ACCESS_ATMOSPHERICS, ACCESS_KITCHEN,
	...
	ACCESS_THEATRE, ACCESS_RESEARCH, ACCESS_MINING, ACCESS_CARGO, ACCESS_WEAPONS_PERMIT,
	...
	ACCESS_KEYCARD_AUTH, ACCESS_TCOMMS, ACCESS_MATERIALS, ACCESS_AI_SAT, ACCESS_TCOMMS_ADMIN, ACCESS_CLONING, ACCESS_PARAMEDIC, ACCESS_CLERK, ACCESS_BRIG_PHYS, ACCESS_PSYCHOLOGY, ACCESS_SERVICE))
