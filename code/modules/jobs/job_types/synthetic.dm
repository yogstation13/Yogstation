GLOBAL_LIST_INIT(synthetic_base_access, list(
		ACCESS_SERVICE, ACCESS_THEATRE, ACCESS_CHAPEL_OFFICE, ACCESS_LIBRARY,
		ACCESS_BAR, ACCESS_KITCHEN, ACCESS_HYDROPONICS, ACCESS_JANITOR,
		ACCESS_LAWYER, ACCESS_CLERK, ACCESS_MAINT_TUNNELS, ACCESS_EXTERNAL_AIRLOCKS,
		ACCESS_AI_SAT, ACCESS_AI_MASTER, ACCESS_EVA, ACCESS_TELEPORTER))
