GLOBAL_LIST_INIT(synthetic_base_access, list(
	...
	ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_COMMAND, ACCESS_CAPTAIN, ACCES_PERSONAL_LOCKERS,
	...
	ACCESS_KEYCARD_AUTH, ACCESS_TCOMMS, ACCESS_MATERIALS, ACCESS_AI_SAT, ACCESS_TCOMMS_ADMIN, ACCESS_CLONING, ACCESS_TCOM_ADMIN, ACCESS_PARAMEDIC, ACCESS_CLERK, ACCESS_BRIG_PHYS, ACCESS_PSYCHOLOGY, ACCESS_SERVICE))
