/datum/job/mining
	...
	added_access = list(ACCESS_MAINT_TUNNELS, ACCESS_CARGO_BAY, ACCESS_QM, ACCESS_SCIENCE, ACCESS_RESEARCH)
	base_access = list(ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION, ACCESS_CARGO, ACCESS_MATERIALS)
