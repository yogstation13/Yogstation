...
/datum/job/miningmedic
	...
	access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY, ACCESS_CARGO, ACCESS_MINT, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_MAILSORTING,
					ACCESS_MINERAL_STOREROOM, ACCESS_MECH_MINING, ACCESS_MECH_MEDICAL)
