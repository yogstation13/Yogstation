/datum/job/hop
	...
	base_access = list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_WEAPONS_PERMIT,
			            ACCESS_MEDICAL, ACCESS_ENGINEERING, ACCESS_CHANGE_IDS, ACCESS_AI_UPLOAD, ACCESS_EVA, ACCESS_COMMAND,
			            ...
			            ACCESS_HOP, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_MATERIALS, ACCESS_CLERK, ACCESS_SERVICE) //yogs - added ACCESS_CLERK as it's the clerk's
