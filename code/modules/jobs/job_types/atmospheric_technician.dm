/datum/job/atmos
	...
	base_access = list(ACCESS_ATMOSPHERICS, ACCESS_ENGINEERING, ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION, ACCESS_MATERIALS, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_MECH_ENGINE)
