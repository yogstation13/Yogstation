/datum/job/atmos
	...
	base_access = list(ACCESS_ATMOSPHERICS, ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION, ACCESS_MECH_ENGINE, ACCESS_MATERIALS, ACCESS_ENGINEERING, ACCESS_EXTERNAL_AIRLOCKS)
