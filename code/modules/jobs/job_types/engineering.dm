...
/datum/job/atmos
	...
	minimal_access = list(ACCESS_ATMOSPHERICS, ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION, ACCESS_MECH_ENGINE, ACCESS_MINERAL_STOREROOM, ACCESS_ENGINE) //Yogs - Atmos techs now have basic engineering access.
	paycheck = PAYCHECK_MEDIUM
	paycheck_department = ACCOUNT_ENG
