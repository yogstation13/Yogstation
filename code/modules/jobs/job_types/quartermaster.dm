/datum/job/qm
	...
	added_access = list()
	base_access = list(ACCESS_MAINT_TUNNELS, ACCESS_CARGO, ACCESS_CARGO, ACCESS_QM, ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION, ACCESS_VAULT, ACCESS_RC_ANNOUNCE)
