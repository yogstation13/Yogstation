/datum/job/officer
	...
	base_access = list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_WEAPONS_PERMIT, ACCESS_MECH_SECURITY, ACCESS_MATERIALS) // See /datum/job/officer/get_access()
