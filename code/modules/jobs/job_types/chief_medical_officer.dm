...
/datum/outfit/job/cmo
	...
	backpack_contents = list(/obj/item/melee/classic_baton/telescopic=1, /obj/item/clothing/glasses/hud/health/sunglasses, /obj/item/modular_computer/tablet) //yogs - removes med budget
