/datum/job/rd
	...
	base_access = list(ACCESS_RD, ACCESS_COMMAND, ACCESS_SCIENCE, ACCESS_TOXINS, ACCESS_GENETICS, ACCESS_MORGUE,
			            ACCESS_TOXINS_STORAGE, ACCESS_TELEPORTER, ACCESS_SEC_BASIC, ACCESS_MECH_SCIENCE,
			            ACCESS_RESEARCH, ACCESS_ROBO_CONTROL, ACCESS_XENOBIOLOGY, ACCESS_AI_MASTER,
			            ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_MATERIALS,
			            ACCESS_TECH_STORAGE, ACCESS_AI_SAT, ACCESS_MAINT_TUNNELS)
