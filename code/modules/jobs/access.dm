...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT,
				...
				ACCESS_CLONING, ACCESS_TCOM_ADMIN, ACCESS_PARAMEDIC, ACCESS_MANUFACTURING, ACCESS_BRIG_PHYS, ACCESS_MEDICAL_MACHINERY) //YOGS - yogs jobs
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(3) //medbay
			return list(ACCESS_MEDICAL, ACCESS_GENETICS, ACCESS_CLONING, ACCESS_MORGUE, ACCESS_CHEMISTRY, ACCESS_VIROLOGY, ACCESS_SURGERY, ACCESS_MECH_MEDICAL, ACCESS_CMO, ACCESS_PARAMEDIC, ACCESS_BRIG_PHYS, ACCESS_MEDICAL_MACHINERY) // yogs - Yog jobs
		if(4) //research
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(ACCESS_MEDICAL_MACHINERY)
			return "Medical Machinery"
		// yogs end
