...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_DETECTIVE, ACCESS_SEC_BASIC,
	            ...
	            ACCESS_KEYCARD_AUTH, ACCESS_TCOMMS, ACCESS_TCOMMS_ADMIN, ACCESS_MATERIALS, ACCESS_AI_SAT, ACCESS_CLONING, ACCESS_TCOM_ADMIN, ACCESS_PARAMEDIC, ACCESS_CLERK, ACCESS_BRIG_PHYS, ACCESS_PSYCHOLOGY, ACCESS_SERVICE) //YOGS - yogs jobs
