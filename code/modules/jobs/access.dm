...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_BASIC, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_DETECTIVE, ACCESS_SEC_BASIC,
	            ...
	            ACCESS_EXTERNAL_AIRLOCKS, ACCESS_CHANGE_IDS, ACCESS_AI_MASTER, ACCESS_AI_SAT,
	            ...
	            ACCESS_THEATRE, ACCESS_SCIENCE, ACCESS_RESEARCH, ACCESS_MINING, ACCESS_CARGO, ACCESS_WEAPONS_PERMIT,
	            ...
	            ACCESS_KEYCARD_AUTH, ACCESS_TCOMMS, ACCESS_TCOMMS_ADMIN, ACCESS_MATERIALS, ACCESS_CLONING, ACCESS_PARAMEDIC, ACCESS_CLERK, ACCESS_BRIG_PHYS, ACCESS_PSYCHOLOGY, ACCESS_SERVICE)
