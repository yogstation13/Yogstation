...
/datum/round_event_control/proc/preRunEvent()
	...
	triggering = TRUE
	if(alert_observers)
		message_admins("<span class='bold'><font color = red>Random Event triggering in [RANDOM_EVENT_ADMIN_INTERVENTION_TIME/10] seconds: [name] (<a href='?src=[REF(src)];cancel=1'>CANCEL</a>)</font color></span>")
