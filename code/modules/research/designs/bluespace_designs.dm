...
/datum/design/bag_holding
	...
	id = "bag_holding"
	build_type = PROTOLATHE
	materials = list(/datum/material/uranium = 3000, /datum/material/diamond = 1500, /datum/material/uranium = 250, /datum/material/bluespace = 2000)
...
/datum/design/miningsatchel_holding
	...
	id = "minerbag_holding"
	build_type = PROTOLATHE
	materials = list(/datum/material/uranium = 250, /datum/material/uranium = 500) //quite cheap, for more convenience
