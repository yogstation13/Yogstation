...
/datum/design/bag_holding
	...
	id = "bag_holding"
	build_type = PROTOLATHE
	materials = list(MAT_GOLD = 3000, MAT_DIAMOND = 1500, /datum/material/uranium = 250, MAT_BLUESPACE = 2000)
...
/datum/design/desynchronizer
	...
	id = "desynchronizer"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 1000, /datum/material/glass = 500, MAT_SILVER = 1500, MAT_BLUESPACE = 1000)
...
/datum/design/miningsatchel_holding
	...
	id = "minerbag_holding"
	build_type = PROTOLATHE
	materials = list(MAT_GOLD = 250, /datum/material/uranium = 500) //quite cheap, for more convenience
