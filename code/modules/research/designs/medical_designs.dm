...
/datum/design/posibrain
	...
	id = "mmi_posi"
	build_type = PROTOLATHE | MECHFAB
	materials = list(/datum/material/iron = 1700, /datum/material/glass = 1350, MAT_GOLD = 500) //Gold, because SWAG.
	construction_time = 75
...
/datum/design/bluespacesyringe
	...
	id = "bluespacesyringe"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 2000, MAT_PLASMA = 1000, MAT_DIAMOND = 1000, MAT_BLUESPACE = 500)
...
/datum/design/cloning_disk
	...
	id = "cloning_disk"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 300, /datum/material/glass = 100, MAT_SILVER = 50)
...
/datum/design/noreactsyringe
	...
	id = "noreactsyringe"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 2000, MAT_GOLD = 1000)
...
/datum/design/piercesyringe
	...
	id = "piercesyringe"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 2000, MAT_DIAMOND = 1000)
...
/datum/design/bluespacebodybag
	...
	id = "bluespacebodybag"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3000, MAT_PLASMA = 2000, MAT_DIAMOND = 500, MAT_BLUESPACE = 500)
...
/datum/design/plasmarefiller
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 4000, MAT_PLASMA = 1000)
...
/datum/design/crewpinpointer
	...
	id = "crewpinpointer"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3000, /datum/material/glass = 1500, MAT_GOLD = 200)
...
/datum/design/defibrillator
	...
	materials = list(/datum/material/iron = 8000, /datum/material/glass = 4000, MAT_SILVER = 3000, MAT_GOLD = 1500)
	category = list("Medical Designs")
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL
...
/datum/design/defibrillator_compact
	...
	materials = list(/datum/material/iron = 16000, /datum/material/glass = 8000, MAT_SILVER = 6000, MAT_GOLD = 3000)
	category = list("Medical Designs")
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL
...
/datum/design/healthanalyzer_advanced
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 5000, /datum/material/glass = 2500, MAT_SILVER = 2000, MAT_GOLD = 1500)
	category = list("Medical Designs")
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL
...
/datum/design/laserscalpel
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 6000, /datum/material/glass = 1500, MAT_SILVER = 2000, MAT_GOLD = 1500, MAT_DIAMOND = 200, MAT_TITANIUM = 4000)
...
/datum/design/mechanicalpinches
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 12000, /datum/material/glass = 4000, MAT_SILVER = 4000, MAT_TITANIUM = 5000)
	category = list("Tool Designs")
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL | DEPARTMENTAL_FLAG_SCIENCE
...
/datum/design/searingtool
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 4000, /datum/material/glass = 2000, MAT_PLASMA = 2000, /datum/material/uranium = 3000, MAT_TITANIUM = 3000)
	category = list("Tool Designs")
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL | DEPARTMENTAL_FLAG_SCIENCE
...
/datum/design/cyberimp_surgical
	...
	id = "ci-surgery"
	build_type = PROTOLATHE | MECHFAB
	materials = list (/datum/material/iron = 2500, /datum/material/glass = 1500, MAT_SILVER = 1500)
...
/datum/design/cyberimp_medical_hud
	...
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 500, MAT_GOLD = 500)
...
/datum/design/cyberimp_security_hud
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 750, MAT_GOLD = 750)
...
/datum/design/cyberimp_diagnostic_hud
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 600, MAT_GOLD = 600)
...
/datum/design/cyberimp_xray
	...
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 600, MAT_GOLD = 600, MAT_PLASMA = 1000, /datum/material/uranium = 1000, MAT_DIAMOND = 1000, MAT_BLUESPACE = 1000)
...
/datum/design/cyberimp_thermals
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 600, MAT_GOLD = 600, MAT_PLASMA = 1000, MAT_DIAMOND = 2000)
...
/datum/design/cyberimp_antidrop
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 400, MAT_GOLD = 400)
...
/datum/design/cyberimp_antistun
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_SILVER = 500, MAT_GOLD = 1000)
...
/datum/design/cyberimp_nutriment
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 40
	materials = list(/datum/material/iron = 500, /datum/material/glass = 500, MAT_GOLD = 500)
...
/datum/design/cyberimp_nutriment_plus
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
	materials = list(/datum/material/iron = 600, /datum/material/glass = 600, MAT_GOLD = 500, /datum/material/uranium = 750)
...
/datum/design/cyberimp_reviver
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 60
	materials = list(/datum/material/iron = 800, /datum/material/glass = 800, MAT_GOLD = 300, /datum/material/uranium = 500)
...
/datum/design/cyberimp_thrusters
	...
	materials = list(/datum/material/iron = 4000, /datum/material/glass = 2000, MAT_SILVER = 1000, MAT_DIAMOND = 1000)
...
/datum/design/implant_sadtrombone
	...
	id = "implant_trombone"
	build_type = PROTOLATHE
	materials = list(/datum/material/glass = 500, MAT_BANANIUM = 500)
...
/datum/design/cybernetic_liver_u
	...
	build_type = PROTOLATHE | MECHFAB
	construction_time = 50
	materials = list(/datum/material/iron = 500, /datum/material/glass = 500, MAT_SILVER=500, MAT_GOLD=200)
