...
/datum/design/drill_diamond
	...
	id = "drill_diamond"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 6000, /datum/material/glass = 1000, MAT_DIAMOND = 2000) //Yes, a whole diamond is needed.
...
/datum/design/plasmacutter
	...
	id = "plasmacutter"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 1500, /datum/material/glass = 500, MAT_PLASMA = 1000, MAT_SILVER = 1000, /datum/material/uranium = 800)
...
/datum/design/plasmacutter_adv
	...
	id = "plasmacutter_adv"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 3000, /datum/material/glass = 1000, MAT_PLASMA = 2000, MAT_GOLD = 2000, /datum/material/uranium = 3000, MAT_DIAMOND = 2000)
...
/datum/design/jackhammer
	...
	id = "jackhammer"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 6000, /datum/material/glass = 2000, MAT_SILVER = 2000, MAT_DIAMOND = 6000)
...
/datum/design/superresonator
	...
	id = "superresonator"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 4000, /datum/material/glass = 1500, MAT_SILVER = 1000, /datum/material/uranium = 1000)
...
/datum/design/trigger_guard_mod
	...
	id = "triggermod"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 2000, /datum/material/glass = 1500, MAT_GOLD = 1500, /datum/material/uranium = 1000)
...
/datum/design/hyperaccelerator
	...
	id = "hypermod"
	build_type = PROTOLATHE | MECHFAB
	materials = list(/datum/material/iron = 8000, /datum/material/glass = 1500, MAT_SILVER = 2000, MAT_GOLD = 2000, MAT_DIAMOND = 2000)
