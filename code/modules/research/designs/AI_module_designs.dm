...
/datum/design/board/safeguard_module
	...
	id = "safeguard_module"
	materials = list(/datum/material/glass = 1000, /datum/material/uranium = 2000)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(/datum/material/glass = 1000, /datum/material/uranium = 10000)//Custom inputs should be more expensive to get
