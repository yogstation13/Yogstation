...
/datum/design/board/safeguard_module
	...
	id = "safeguard_module"
	materials = list(/datum/material/glass = 1000, MAT_GOLD = 2000)
...
/datum/design/board/onehuman_module
	...
	id = "onehuman_module"
	materials = list(/datum/material/glass = 1000, MAT_DIAMOND = 6000)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(/datum/material/glass = 1000, MAT_GOLD = 10000)//Custom inputs should be more expensive to get
...
/datum/design/board/purge_module
	...
	id = "purge_module"
	materials = list(/datum/material/glass = 1000, MAT_DIAMOND = 2000)
...
/datum/design/board/freeformcore_module
	...
	materials = list(/datum/material/glass = 1000, MAT_DIAMOND = 10000)//Ditto
