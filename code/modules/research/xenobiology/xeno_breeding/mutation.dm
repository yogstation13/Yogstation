...
/datum/xeno_mutation/proc/AddToMob(mob/living/simple_animal/hostile/xenobio/mutant, is_inert = FALSE, force = FALSE)
...
/datum/xeno_mutation/proc/CanMutate(mob/living/simple_animal/hostile/xenobio/mutant)
