...
/obj/item/slimecross/regenerative/afterattack(atom/target,mob/user,prox)
	...
	if(H.stat == DEAD)
		...
		return
	if(H != user)
		user.visible_message(span_notice("[user] crushes the [src] over [H], the milky goo quickly regenerating some of [H.p_their()] injuries!"),
			span_notice("You squeeze the [src], and it bursts over [H], the milky goo regenerating [H.p_their()] injuries."))
	else
		user.visible_message(span_notice("[user] crushes the [src] over [user.p_them()]self, the milky goo quickly regenerating some of [user.p_their()] injuries!"),
...
/obj/item/slimecross/regenerative/purple
	colour = "purple"
	effect_desc = "Partially heals the target and injects them with some regen jelly."
...
/obj/item/slimecross/regenerative/blue
	colour = "blue"
	effect_desc = "Partially heals the target and makes the floor wet."
...
/obj/item/slimecross/regenerative/metal
	colour = "metal"
	effect_desc = "Partially heals the target and encases the target in a locker."
...
/obj/item/slimecross/regenerative/yellow
	colour = "yellow"
	effect_desc = "Partially heals the target and fully recharges a single item on the target."
...
/obj/item/slimecross/regenerative/cerulean
	colour = "cerulean"
	effect_desc = "Partially heals the target and makes a second regenerative core with no special effects."
...
/obj/item/slimecross/regenerative/pyrite
	colour = "pyrite"
	effect_desc = "Partially heals the target and randomly colors them."
...
/obj/item/slimecross/regenerative/red
	colour = "red"
	effect_desc = "Partially heals the target and injects them with some ephedrine."
...
/obj/item/slimecross/regenerative/green
	colour = "green"
	effect_desc = "Partially heals the target and changes the spieces or color of a slime or jellyperson."
...
/obj/item/slimecross/regenerative/adamantine
	colour = "adamantine"
	effect_desc = "Partially heals the target and boosts their armor."
