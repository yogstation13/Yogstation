...
/obj/item/clothing/mask/nobreath
	...
	desc = "A transparent mask, resembling a conventional breath mask, but made of bluish slime. Seems to lack any air supply tube, though. (this breath mask isnt activatable it works even when off)."
	icon_state = "slime"
	item_state = "slime"
