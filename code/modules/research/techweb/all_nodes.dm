...
/datum/techweb_node/base
	...
	design_ids = list("basic_matter_bin", "basic_cell", "basic_scanning", "basic_capacitor", "basic_micro_laser", "micro_mani", "desttagger", "handlabel", "packagewrap", "recorder", "recorder_tape", "spraycan", "pillbottle", "kitchen_knife", "rcd_ammo", "camera_film", "camera",
	"destructive_analyzer", "circuit_imprinter", "rack_creator", "experimentor", "rdconsole", "design_disk", "tech_disk", "rdserver", "rdservercontrol", "mechfab", "paystand", "ticket_machine", "ticket_remote", "light_tube", "light_bulb", "earmuffs", "laptop", "phone", "tablet", "pda",
...
/datum/techweb_node/adv_engi
	...
	design_ids = list("engine_goggles", "magboots", "forcefield_projector", "weldingmask", "decontamination_unit", "tricorder")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
