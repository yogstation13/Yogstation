...
/datum/techweb_node/base
	...
	"space_heater", "beaker", "large_beaker", "vial", "large_vial", "bucket", "fork", "tray","plate", "bowl", "mixing_bowl", "drinking_glass", "shot_glass", "shaker", "xlarge_beaker", "sec_rshot", "sec_beanbag_slug", "sec_bshot", "sec_slug", "sec_Islug", "sec_Brslug", "techshotshell", "sec_38", "sec_38_lethal", "apc_control", "power control", "airlock_board", "firelock_board", "airalarm_electronics", "firealarm_electronics", "blastdoorcontroller", "aac_electronics", "mousetrap",
...
/datum/techweb_node/exotic_ammo
	...
	design_ids = list("mag_v38_bluespace", "mag_oldsmg_kraken", "mag_oldsmg_snakebite")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
