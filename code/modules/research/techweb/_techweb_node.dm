...
/datum/techweb_node
	...
	var/experimental = FALSE	//If the tech can be randomly generated by the BEPIS as a reward. MEant to be fully given in tech disks, not researched
...
/datum/techweb_node/deserialize_list(list/input, list/options)
	...
	VARSET_FROM_LIST(input, experimental)
