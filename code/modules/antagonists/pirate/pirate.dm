...
/datum/antagonist/pirate/greet()
	...
	to_chat(owner, "<B>The station refused to pay for your protection, protect the ship, siphon the credits from the station and raid it for even more loot.</B><span class='notice'> As a pirate, you are NOT authorized to senselessly murder the station's inhabitants without reason.</span>")
