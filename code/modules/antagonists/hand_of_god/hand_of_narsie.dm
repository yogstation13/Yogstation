...
/datum/antagonist/hand_of_god/hand_of_narsie/greet()
...
/datum/antagonist/hand_of_god/hand_of_narsie/on_gain()
	. = ..()
...
*/
/datum/antagonist/hand_of_god/hand_of_narsie/get_preview_icon()
...
/datum/antagonist/hand_of_god/hand_of_narsie/proc/equip_cultist(metal=TRUE)
...
/datum/antagonist/hand_of_god/hand_of_narsie/proc/cult_give_item(obj/item/item_path, mob/living/carbon/human/current_mob)
	var/list/slots = list(
...
/datum/antagonist/hand_of_god/hand_of_narsie/apply_innate_effects(mob/living/mob_override)
	. = ..()
	var/mob/living/current = owner.current
	if(mob_override)
...
/datum/antagonist/hand_of_god/hand_of_narsie/remove_innate_effects(mob/living/mob_override)
	. = ..()
	var/mob/living/current = owner.current
	if(mob_override)
		current = mob_override
...
/datum/antagonist/hand_of_god/hand_of_narsie/admin_add(datum/mind/new_owner,mob/admin)
...
/datum/antagonist/hand_of_god/hand_of_narsie/admin_remove(mob/user)
...
/datum/antagonist/hand_of_god/hand_of_narsie/get_admin_commands()
	. = ..()
...
/datum/antagonist/hand_of_god/hand_of_narsie/proc/admin_give_dagger(mob/admin)
	if(!equip_cultist(metal=FALSE))
		to_chat(admin, span_danger("Spawning dagger failed!"))

/datum/antagonist/hand_of_god/hand_of_narsie/proc/admin_give_metal(mob/admin)
	if (!equip_cultist(metal=TRUE))
		to_chat(admin, span_danger("Spawning runed metal failed!"))

/datum/antagonist/hand_of_god/hand_of_narsie/proc/admin_take_all(mob/admin)
	var/mob/living/current = owner.current
...
/datum/antagonist/hand_of_god/hand_of_narsie/master
	ignore_implant = TRUE
...
/datum/antagonist/hand_of_god/hand_of_narsie/master/greet()
...
/datum/antagonist/hand_of_god/hand_of_narsie/master/apply_innate_effects(mob/living/mob_override)
	. = ..()
	var/mob/living/current = owner.current
	if(mob_override)
		current = mob_override
...
/datum/team/hand_of_god/hand_of_narsie/proc/check_size()
	if(cult_ascendent)
		return
	var/alive = 0
	var/cultplayers = 0
...
/datum/team/hand_of_god/hand_of_narsie/proc/rise(cultist)
	if(ishuman(cultist))
