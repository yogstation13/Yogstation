...
/datum/action/cooldown/spell/aoe/immobilize/famishd_roar
	name = "Famished Roar"
...
/datum/action/cooldown/spell/aoe/immobilize/famishd_roar/get_things_to_cast_on(atom/center)
	var/list/things = list()
...
/datum/action/cooldown/spell/aoe/immobilize/famishd_roar/cast_on_thing_in_aoe(atom/movable/victim, atom/caster)
	if(ismob(victim))
	...
	if(dist_from_caster == 0)
		...
		if(isliving(victim))
			var/mob/living/victim_living = victim
			victim_living.Immobilize(5 SECONDS)
