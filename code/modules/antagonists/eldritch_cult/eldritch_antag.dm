...
/datum/antagonist/heretic/roundend_report()
	...
	parts += get_flavour(cultiewin, ascended, transformed, lore)

	return parts.Join("<br>")

/datum/antagonist/heretic/proc/get_flavour(cultiewin, ascended, transformed, lore)
	...
	if(is_ash()) //Ash epilogues
		...
		if(ascended)
			...
			if(escaped)
				flavour_message += 	"You step off the shuttle as smoke curls off your form. Light seeps from openings in your body, and you quickly retire to the Mansus. \
				...
				flavour_message += 	"For a while you bask in your heat, wandering the mostly-empty halls of the station. Then, you slip back into the Mansus and head to \
				...
				flavour_message += 	"Your soul wanders back into the Mansus after your mortal body falls, and you find yourself in the endless dunes of the Kilnplains. \
			...
			if(escaped)
				flavour_message += 	"You step off the shuttle with a feeling of pride. This day, you have accomplished what you set out to do. Could more have been done? \
				...
				flavour_message += 	"This can be considered a victory, you suppose. It will not be difficult to traverse back into the Mansus with what you know, \
				...
				flavour_message += 	"You touched the Kilnplains, and it will not let you go. While you do not rise as one of the Ashmen, your skin is still grey, \
			...
			if(escaped)
				flavour_message += 	"A setback is unideal. But at least you have escaped with your body and some knowledge intact. There will be opportunities, \
				...
				flavour_message += 	"Disappointment fans your chest. Perhaps you will be able to escape. Perhaps you will have a second chance. \
				...
				flavour_message += 	"You touched the Kilnplains, and it will not let you go. Pitiful as you may be, it still drags you back as a \
		...
		if(ascended)
			...
			if(transformed) //If you became a Thirstly Serpent
				if(escaped)
					flavour_message += 	"You RACE and you CRAWL everywhere through the shuttle. The doors open to Centcom and you simply must OOZE out into the halls. The GREAT \
					...
					flavour_message += 	"SKITTERING and LEAPING through these NEW halls. They are FAMILIAR and FRESH all the same! EACH of your legs WRIGGLES and FEELS the \
					...
					flavour_message += 	"WHAT has happened to your GLORIOUS new form? You ATE and ATE and ATE and you were WONDEROUS! The once-master scoffs at you now- \
				...
				if(escaped)
					flavour_message += 	"A moment passes before you quickly exit the shuttle. You leave into the Mansus even quicker. Then, you travel through the Wood, your body free \
					...
					flavour_message += 	"You wonder what will become of your creation. You feel the Cup flow through you, but you channeled the Glorious Feast into another. \
					...
					flavour_message += 	"You wonder if this was the path you should have chosen. Oathbreakers are a prized possession of Sworn looking to uphold their highest \
			...
			if(escaped)
				flavour_message += 	"It is impossible to hold back laughter once you arrive at Centcom. You have won! Soon, you will slide back into the Mansus, and from there \
				...
				flavour_message += 	"You exhale a sigh of happiness. Not many could have accomplished what you have. Could you have gone further? Certainly. Ascension is a \
									...
									If not, the Badlands within the Mansus is always filled with travellers coming to and from the Wood, all over and around the ethereal place. \
									Some will bend. They will obey. The Red Oath must always be upheld."
				message_color = "#008000"
			else //Dead
				flavour_message += 	"A taste, a glimmer of the thrill is enough for you. Perhaps you could have partaken more, but a minor appetite was more than \
			...
			if(escaped)
				flavour_message += 	"Escape is escape. You did not claim the day as you thought you would. You refuse to show your head in the Crimson Church \
				...
				flavour_message += 	"Stranded and defeated. Perhaps others still linger who you can force to help your escape. The Mansus is closed \
				...
				flavour_message += 	"And so ends your tale. Who knows what you could have become? How many could you have bent to their knees? \
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"The shuttle sputters and finally dies as you step onto Centcom, the floor tiling beneath your feet already beginning to decay. Disgusted, \
				...
				flavour_message += 	"Flickering screens and dimming lights surround you as you walk amidst the station's corridors. As the final sparks of power fizzle out, \
				...
				flavour_message += 	"All that is made must one day be unmade. The same goes for your weak body. But even without a form, the force of decay will always be \
			...
			if(escaped)
				flavour_message += 	"The shuttle creaks as you arrive, and you make your way through Centcom briefly. The ship away creaks louder, and you decide to \
				...
				flavour_message += 	"Something has been accomplished. You could have gone further. But at least with the power you wield, your time aboard the rapidly-failing \
				...
				flavour_message += 	"Your mortal body is quick to degrade as your soul remains. The Drifter's spite grows in you, building, until you realize \
			...
			if(escaped)
				flavour_message += 	"Your fingers are beginning to rot away. The River Krym will make its promise due eventually. But until then, you have time \
				...
				flavour_message += 	"There is naught left here for you to infest. These corridors are now empty, the halls pointless. To decay what \
				...
				flavour_message += 	"Civilizations rise and fall like the current, flowing in and out, one replacing the other over time: dominion \
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"Sitting tight in your seat, as you hear the hiss of the shuttle doors open everything begins to grow dark, you hear the crying of a baby and the smell of salt. \
				...
				flavour_message += 	"As you watch the escape shuttle leave with dull eyes, you turn to the others left behind, the sickly smell of blood fills the station's corridors. \
				...
				flavour_message += 	"As your body hits the floor, you expect the sweet release of death to free you from this horrid nightmare, unfortunately as your consciousness slips away, \
			...
			if(escaped)
				...
				flavour_message += 	"You've survived, not many can claim the same. You wait every night for the dark dream to take you, going back to the beach upon which you expect your end.\
				...
				flavour_message += 	"As you let out one last gasp of air, the light begins to leave your eyes as a small smile crosses your lips. \
			...
			if(escaped)
				flavour_message += 	"You've escaped the station, but as the shuttle lands at Centcom it all goes dark, dragged to the Mansus you look around you \
				...
				flavour_message += 	"You step through the ruined halls of the station, the clicking of your soles against the tile your only company. \
				...
				flavour_message += 	"Your beaten and battered body lays there, your consciousness still trapped in it like a prison of flesh. \
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"Arriving at Centcom you smile, the infinite winds billow behind your back, bringing a new age of Ice to the system."
			else if(alive)
				flavour_message += 	"You watch as the shuttle leaves, smirking, you turn your gaze to the planet below, planning your next moves carefully, ready to expand your domain of Ice."
			else //Dead
				flavour_message += 	"Your body freezes and shatters, but it is not the end. Your eternal spirit will live on, and the storm you called will never stop in this sector. You have won the war."
	
		else if(cultiewin) //Completed objectives
			if(escaped)
				flavour_message += 	"The mission is done, the stage is set, though you did not reach the peak of power, you achieved what many thought impossible."
				message_color = "#008000"
			else if(alive)
				flavour_message += 	"Your success has been noted, and the coming storm will grant you powers of ice beyond all mortal comprehension. You need only wait..."
				message_color = "#008000"
			else //Dead
				flavour_message += 	"As your body crumbles to snow, you smile one last toothy grin, knowing the fate of those who will freeze, despite your demise."
				message_color = "#517fff"

		else //Failed objectives
			if(escaped)
				flavour_message += 	"You escaped, but at what cost? Your mission a failure, along with you. The coming days will not be kind."
				message_color = "#517fff"
			else if(alive)
				flavour_message += 	"Stepping through the empty halls of the station, you look towards the empty space, and contemplate your failures."
			else //Dead
				flavour_message += 	"As your body shatters, the last pieces of your consciousness wonder what you could have done differently, before the spark of life dissipates."
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"The hallway leading to the shuttle explodes in a whirlwind of blades, each step you take cutting a path to your new reality."
			else if(alive)
				flavour_message += 	"Watching the shuttle as it jumps to warp puts a smile on your face, you ready your blade to cut through space and time. They won't escape."
			else //Dead
				flavour_message += 	"As your blade falls from your hand, it hits the ground and shatters, splintering into an uncountable amount of smaller blades. As long as one survives, your soul will exist, and you will return to cut again."
	
		else if(cultiewin) //Completed objectives
			if(escaped)
				flavour_message += 	"You've crafted an impossible amount of blades, and made a mountain of corpses doing so. Victory is yours today!"
				message_color = "#008000"
			else if(alive)
				flavour_message += 	"You sharpen your newly formed blade, made from the bones and soul of your enemies. Smirking, you think of new and twisted ways to continue your craft."
				message_color = "#008000"
			else //Dead
				flavour_message += 	"As the world goes dark, a flash of steel crosses the boundry between reality and the veil. Though you may pass here, those who felled you will not last."
				message_color = "#517fff"

		else //Failed objectives
			if(escaped)
				flavour_message += 	"You sit on a bench at centcom, escaping the madness of the station. You've failed, and will never smith a blade again."
				message_color = "#517fff"
			else if(alive)
				flavour_message += 	"Your bloodied hand pounds on the nearest wall, a failure of a smith you turned out to be. You pray someone finds your emergency beacon on this abandoned station."
			else //Dead
				flavour_message += 	"You lay there, life draining from your body onto the station around you. The last thing you see is your reflection in your own blade, and then it all goes dark."
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"As the shuttle docks cosmic radiation pours from the doors, the lifeless corpses of those who dared defy you remain. Unmake the rest of them."
			else if(alive)
				flavour_message += 	"You turn to watch the escape shuttle leave, waving a small goodbye before beginning your new duty: Remaking the cosmos in your image."
			else //Dead
				flavour_message += 	"A loud scream is heard around the cosmos, your death cry will awaken your brothers and sisters, you will be remembered as a martyr."
	
		else if(cultiewin) //Completed objectives
			if(escaped)
				flavour_message += 	"You completed everything you had set out to do and more on this station, now you must take the art of the cosmos to the rest of humanity."
				message_color = "#008000"
			else if(alive)
				flavour_message += 	"You feel the great creator look upon you with glee, opening a portal to his realm for you to join it."
				message_color = "#008000"
			else //Dead
				flavour_message += 	"As your body melts away into the stars, your consciousness carries on to the nearest star, beginning a super nova. A victory, in a sense."
				message_color = "#517fff"

		else //Failed objectives
			if(escaped)
				flavour_message += 	"You step off the shuttle, knowing your time is limited now that you have failed. Cosmic radiation seeps through your soul, what will you do next?"
				message_color = "#517fff"
			else if(alive)
				flavour_message += 	"Dragging your feet through what remains of the ruined station, you can only laugh as the stars continue to twinkle in the sky, despite everything."
			else //Dead
				flavour_message += 	"Your skin turns to dust and your bones reduce to raw atoms, you will be forgotten in the new cosmic age."
		...
		if(ascended)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"The shuttle docks at Centcom, the doors open but instead of people a mass of horrors pour out, consuming everyone in their path."
			else if(alive)
				flavour_message += 	"You've opened the door, unlocked the lock, became the key. Crack open the rest of reality, door by door."
			else //Dead
				flavour_message += 	"For a fleeting moment, you opened a portal to the end of days. Nothing could have brought you greater satisfaction, and you pass in peace"
	
		else if(cultiewin) //Completed objectives
			if(escaped)
				flavour_message += 	"With each gleeful step you take through the station, you look at the passing airlocks, knowing the truth that you will bring."
				message_color = "#008000"
			else if(alive)
				flavour_message += 	"The shuttle is gone, you are alone. And yet, as you turn to the nearest airlock, what waits beyond is something only you can see."
				message_color = "#008000"
			else //Dead
				flavour_message += 	"Your death is not your end, as your bones will become the key for another's path to glory."
				message_color = "#517fff"

		else //Failed objectives
			if(escaped)
				flavour_message += 	"You escaped, but for what? For the rest of your life you avoid doorways, knowing that once you pass through one, you may not come back."
				message_color = "#517fff"
			else if(alive)
				flavour_message += 	"Step by step, you walk the halls of the abandonded tarnished station, ID in hand looking for the right door. The door to oblivion."
			else //Dead
				flavour_message += 	"As the last of your life drains from you, all you can manage is to lay there dying. Nobody will remember your deeds here today."
	else //Unpledged epilogues

		if(cultiewin) //Completed objectives (WITH NO RESEARCH MIND YOU)
			message_color = "#FFD700"
			if(escaped)
				flavour_message += 	"You have always delighted in challenges. You heard the call of the Mansus, yet you chose not to pledge to any principle. \
			...
			if(escaped)
				flavour_message += 	"You decided not to follow the power you had become aware of. From time to time, you will return to the Wood in \
				...
				flavour_message += 	"What purpose did you serve? Your mind had been opened to greatness, yet you denied it and chose to live your \
				...
				flavour_message += 	"Perhaps it is better this way. You chose not to make a plunge into the Mansus, yet your soul returns to it. \
