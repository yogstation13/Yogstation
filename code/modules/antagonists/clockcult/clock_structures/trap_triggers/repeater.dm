...
/obj/structure/clockwork/trap/trigger/repeater
	name = "repeater"
...
/obj/structure/clockwork/trap/trigger/repeater/attack_hand(mob/living/user)
	. = ..()
	if(.)
		return
...
/obj/structure/clockwork/trap/trigger/repeater/process()
	activate()
	playsound(src, 'sound/items/screwdriver2.ogg', 25, FALSE)

/obj/structure/clockwork/trap/trigger/repeater/Destroy()
	STOP_PROCESSING(SSprocessing, src)
	return ..()
