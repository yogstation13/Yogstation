...
/obj/structure/clockwork/trap/steam_vent
	name = "steam vent"
...
/obj/structure/clockwork/trap/steam_vent/activate()
	opacity = !opacity
...
/obj/structure/clockwork/trap/steam_vent/Crossed(atom/movable/AM)
	. = ..()
