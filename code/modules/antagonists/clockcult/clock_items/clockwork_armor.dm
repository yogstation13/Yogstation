...
/obj/item/clothing/suit/armor/clockwork
	...
	resistance_flags = FIRE_PROOF | ACID_PROOF
	armor = list("melee" = 60, "bullet" = 70, "laser" = -25, "energy" = 0, "bomb" = 60, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100)
<<<<<<< HEAD:code/modules/antagonists/clockcult/clock_items/clockwork_armor.dm
...
>>>>>>> d30da792ce... Merge remote-tracking branch 'upstream/master' into pets:code/modules/antagonists/clockcult/clock_items/clockwork_armor.dm
