...
/datum/clockwork_scripture/ranged_ability/kindle
	...
	sort_priority = 4
	slab_overlay = "volt"
	ranged_type = /datum/action/cooldown/pointed/slab/kindle
...
/datum/clockwork_scripture/ranged_ability/hateful_manacles
	...
	primary_component = BELLIGERENT_EYE
	sort_priority = 5
	ranged_type = /datum/action/cooldown/pointed/slab/hateful_manacles
...
/datum/clockwork_scripture/ranged_ability/sentinels_compromise
	...
	ranged_type = /datum/action/cooldown/pointed/slab/compromise
