...
/datum/team/xeno/roundend_report()
	var/list/parts = list()
	parts += "<span class='header'>The [name] [SSshuttle.emergency.is_hijacked_by_xenos() ? "were [span_greentext("successful")]" : "have [span_redtext("failed")]"] in hijacking the shuttle!</span>\n"
	parts += "The [name] were:"
...
//XENO
/mob/living/carbon/alien/mind_Initialize(mapload)
	..()
