...
/obj/structure/bloodsucker/bloodaltar/attack_hand(mob/user, list/modifiers)
	...
	if(!bloodsuckerdatum.current_task)
		...
		if(bloodsuckerdatum.my_clan == CLAN_HECATA)
			to_chat(user, span_boldnotice("These blood bounties no longer interest you, get back on task."))
			return
...
/obj/structure/bloodsucker/bloodaltar
	name = "spectral altar"
	desc = "A simple dark table with an eerie atmosphere around it."
	icon_state = "bloodaltar"
	density = TRUE
	anchored = FALSE
	climbable = TRUE
	...
	var/sacrificialtask = FALSE
	var/organ_name = ""
	Ghost_desc = "This is a Spectral altar, where a Hecata bloodsucker can summon the help of a revenant."
	Vamp_desc = "This is a Spectral altar, where you can enlist the help of a revenant.\n\
		Interact with the Altar to attempt to summon a revenant if you do not yet have one.\n\
		If the table is destroyed, the revenant connected it will perish.\n\
		Summoning a revenant will cost you one rank."
	Vassal_desc = "This is the blood altar, where your master does bounties to advanced their bloodsucking powers.\n\
		Aid your master by bringing them what they need for these bounties or help getting them."
	Hunter_desc = "This is a blood altar, where monsters usually practice a sort of bounty system to advanced their powers.\n\
		They normally sacrifice hearts or blood in exchange for these ranks, forcing them to move out of their lair.\n\
