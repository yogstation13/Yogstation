...
/datum/antagonist/bloodsucker/roundend_report()
	...
	report += get_flavour(objectives_complete, optional_objectives_complete)

	return report.Join("<br>")

/// Evaluates the conditions of the bloodsucker at the end of each round to pick a flavour message to add
/datum/antagonist/bloodsucker/proc/get_flavour(objectives_complete, optional_objectives_complete)
	...
	flavour += "<div><font color='#6d6dff'>Epilogue: </font>"
	...
	flavour += "<font color=[message_color]>[flavour_message]</font></div>"
	return "<div>[flavour.Join("<br>")]</div>"
