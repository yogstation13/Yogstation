...
/datum/blobstrain/reagent/energized_jelly
	...
	analyserdescdamage = "Does low stamina damage, high oxygen damage, and prevents targets from breathing."
	analyserdesceffect = "Is immune to electricity and will easily conduct it, but is weak to EMPs."
	color = "#EFD65A"
...
/datum/reagent/blob/energized_jelly/reaction_mob(mob/living/M, methods = TOUCH, reac_volume, show_message, permeability, mob/camera/blob/O)
	reac_volume = ..()
