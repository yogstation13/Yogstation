...
/datum/blobstrain/reagent/shifting_fragments
	...
	analyserdescdamage = "Does medium brute damage."
	analyserdesceffect = "When attacked, may shift away from the attacker."
	color = "#C8963C"
...
/datum/reagent/blob/shifting_fragments/reaction_mob(mob/living/M, methods = TOUCH, reac_volume, show_message, permeability, mob/camera/blob/O)
	reac_volume = ..()
