...
/datum/blobstrain/reagent/networked_fibers
	...
	analyserdescdamage = "Does high brute and burn damage."
	analyserdesceffect = "Is highly mobile and generates resources rapidly."
	color = "#CDC0B0"
...
/datum/reagent/blob/networked_fibers/reaction_mob(mob/living/M, methods = TOUCH, reac_volume, show_message, permeability, mob/camera/blob/O)
	reac_volume = ..()
