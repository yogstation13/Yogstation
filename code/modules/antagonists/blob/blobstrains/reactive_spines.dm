...
/datum/blobstrain/reagent/reactive_spines
	...
	analyserdescdamage = "Does medium brute damage, ignoring armor and bio resistance."
	analyserdesceffect = "When attacked with brute damage, will lash out, attacking everything near it."
	color = "#9ACD32"
...
/datum/reagent/blob/reactive_spines/reaction_mob(mob/living/M, methods = TOUCH, reac_volume, show_message, permeability, mob/camera/blob/O)
