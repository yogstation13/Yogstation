...
GLOBAL_LIST_INIT(lawlorify, list (
		LORE = list(
			...
			BANE_HARVEST = "Presenting the labours of a harvest will disrupt the devil.",
		...
		LAW = list(
			OBLIGATION_FOOD = "When not acting in self defence, you must always offer your victim food before harming them.",
			...
			BAN_HURTWOMAN = "You must never harm a female outside of self defence.",
			...
			BAN_HURTLIZARD = "You must never harm a lizardman outside of self defence.",
			BAN_HURTANIMAL = "You must never harm a non-sentient creature or robot outside of self defence.",
