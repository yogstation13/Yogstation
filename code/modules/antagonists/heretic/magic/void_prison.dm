...
/datum/status_effect/void_prison/on_remove()
	...
	if(stasis_overlay)
		...
		owner.remove_traits(list(TRAIT_NO_TRANSFORM, TRAIT_SOFTSPOKEN), TRAIT_STATUS_EFFECT(id))
...
/datum/status_effect/void_prison/proc/enter_prison(mob/living/prisoner)
	...
	prisoner.add_traits(list(TRAIT_NO_TRANSFORM, TRAIT_SOFTSPOKEN), TRAIT_STATUS_EFFECT(id))
