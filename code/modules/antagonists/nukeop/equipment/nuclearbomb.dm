...
/obj/machinery/nuclearbomb/beer/actually_explode()
	...
	if(is_station_level(bomb_location.z))
		var/datum/round_event_control/E = locate(/datum/round_event_control/vent_clog/beer) in SSevents.all_events
		if(E)
			E.runEvent()
...
/obj/item/disk/nuclear/process()
	...
	if(newturf && lastlocation == newturf)
		if(last_disk_move < world.time - 5000 && prob((world.time - 5000 - last_disk_move)*0.0001))
			var/datum/round_event_control/operative/loneop = locate(/datum/round_event_control/operative) in SSevents.all_events
