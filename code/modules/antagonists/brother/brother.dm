...
/datum/antagonist/brother/get_preview_icon()
	...
	var/icon/brother1_icon = render_preview_outfit(/datum/outfit/job/officer, brother1)
	brother1_icon.Blend(icon('icons/effects/blood.dmi', "maskblood"), ICON_OVERLAY)
	brother1_icon.Shift(WEST, 8)

	var/icon/brother2_icon = render_preview_outfit(/datum/outfit/job/officer, brother2)
