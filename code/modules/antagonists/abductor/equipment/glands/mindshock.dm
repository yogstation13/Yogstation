/obj/item/organ/heart/gland/mindshock
	abductor_hint = "neural crosstalk uninhibitor. It makes the abductee emits a disrupting psychic wave every so often. This will either stun, cause hallucinations or deal random brain damage to people nearby."
