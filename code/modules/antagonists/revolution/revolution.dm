...
/datum/team/revolution/roundend_report()
	...
	if(check_victory())
		for(var/H in revs)
			var/datum/mind/M = H
			M.current.client.give_award(/datum/award/achievement/antagonist/revolution, M.current)
			if(M.has_antag_datum(/datum/antagonist/rev/head))
				M.current.client.give_award(/datum/award/achievement/antagonist/revolution/head, M.current)
