...
/datum/team/revolution/proc/process_victory(revs_win_injection_amount)
	...
	if (. == STATION_VICTORY)
		...
		We have remotely blacklisted the head revolutionaries in your medical records to prevent accidental revival.", null, 'sound/ai/default/attention.ogg', null, "Central Command Loyalty Monitoring Division")
	else
		...
		[pick(world.file2list("strings/anti_union_propaganda.txt"))]", null, 'sound/ai/default/attention.ogg', null, "Central Command Loyalty Monitoring Division")
