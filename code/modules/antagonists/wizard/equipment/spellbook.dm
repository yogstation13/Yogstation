...
/datum/spellbook_entry/item/rune_crate
	name = "Rune Crate"
	desc = "A wizard specialized in runecrafting is offering a chest full of runes! The problem is, he mixed up the contents so you won't know what you will get!"
