/obj/machinery/vending/autodrobe
	...
	products = list(/obj/item/clothing/suit/chickensuit = 1,
					...
					/obj/item/clothing/under/rank/civilian/mime/twosexytwomime = 1,
...
/obj/machinery/vending/autodrobe/capdrobe
	...
	product_slogans = "Dress for success!;Suited and booted!;It's show time!;Why leave style up to fate? Use the District Administrator's Autodrobe!"
	vend_reply = "Thank you for using the District Administrator's Autodrobe!"
	products = list(/obj/item/clothing/suit/hooded/wintercoat/captain = 1,
					...
					/obj/item/clothing/under/rank/command/captain = 1,
					/obj/item/clothing/under/rank/command/captain/skirt = 1,
