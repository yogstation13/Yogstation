/obj/machinery/vending/donksofttoyvendor
	...
	products = list(
		...
		/obj/item/gun/magic/hook/sickly_blade_toy = 1,
		/obj/item/gun/magic/hook/sickly_blade_toy/rust_toy = 1,
		/obj/item/gun/magic/hook/sickly_blade_toy/ash_toy = 1,
		/obj/item/gun/magic/hook/sickly_blade_toy/flesh_toy =1)
	contraband = list(
