...
/datum/reagent/medicine/rezadone
	name = "Rezadone"
	description = "A powder derived from Chili's seeds, Rezadone can effectively treat genetic damage as well as restoring minor wounds. Overdose will cause intense nausea and minor toxin damage."
	reagent_state = SOLID
