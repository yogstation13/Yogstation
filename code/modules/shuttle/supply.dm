			...
			if(SO.paying_account)
				if(!miscboxes.len || !miscboxes[D.account_holder]) //if there's no miscbox for this person
					if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_MED))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/medical(pick_n_take(empty_turfs), SO.paying_account)
					else if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_ENG))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/engineering(pick_n_take(empty_turfs), SO.paying_account)
					else if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_SCI))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/science(pick_n_take(empty_turfs), SO.paying_account)
					else if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_SRV))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/hydroponics(pick_n_take(empty_turfs), SO.paying_account)
					else if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_SEC))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/gear(pick_n_take(empty_turfs), SO.paying_account)
					else if(SO.paying_account == SSeconomy.get_dep_account(ACCOUNT_CIV))
						miscboxes[D.account_holder] = new /obj/structure/closet/crate/secure/owned/civ(pick_n_take(empty_turfs), SO.paying_account)
					else
