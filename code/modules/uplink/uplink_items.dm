...
/datum/uplink_item/race_restricted/flyingfang
	...
	desc = "This scroll contains a set of old lizard fighting techniques, increasing your melee combat effectiveness but preventing you from using armor or guns."
	cost = 14
