...
/datum/uplink_item/device_tools/mdrive
	...
	kinetic energy and use it in a way that moves the user to their destination at a speed comparable to teleportation, so long as an unobstructed path between the two exists."
