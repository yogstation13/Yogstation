...
/datum/uplink_item/implants/emp_shield
	...
	desc = "Developed by Cybersun to assist with the SELF movement, this implant will protect you and your insides immune to electromagnetic interference, protecting you from ion-based weaponry and EMPs. \
