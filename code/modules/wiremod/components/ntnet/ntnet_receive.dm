 ...
 */
/obj/item/circuit_component/ntnet_receiver
...
/obj/item/circuit_component/ntnet_receiver/populate_options()
	list_options = add_option_port("List Type", GLOB.wiremod_basic_types)

/obj/item/circuit_component/ntnet_receiver/populate_ports()
...
/obj/item/circuit_component/ntnet_receiver/pre_input_received(datum/port/input/port)
	if(port == list_options)
		var/new_datatype = list_options.value
		data_package.set_datatype(PORT_TYPE_LIST(new_datatype))


/obj/item/circuit_component/ntnet_receiver/proc/ntnet_receive(obj/item/circuit_component/ntnet_send/source, list/data)
	SIGNAL_HANDLER
