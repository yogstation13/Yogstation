...
GLOBAL_LIST_INIT(meteors_stray, list(
	/obj/effect/meteor/medium=15, 
	/obj/effect/meteor/big=10,
	/obj/effect/meteor/flaming=25, 
	/obj/effect/meteor/irradiated=30, 
	/obj/effect/meteor/carp=25, 
	/obj/effect/meteor/bluespace=30,
	/obj/effect/meteor/banana=25, 
	/obj/effect/meteor/meaty=10, 
	/obj/effect/meteor/meaty/xeno=8, 
	/obj/effect/meteor/emp = 30,
	/obj/effect/meteor/cluster=20, 
	/obj/effect/meteor/tunguska=1
	)) //for stray meteor event (bigger numbers for a bit finer weighting)

GLOBAL_LIST_INIT(meteorsSPOOKY, list(
	/obj/effect/meteor/pumpkin = 1
	))
