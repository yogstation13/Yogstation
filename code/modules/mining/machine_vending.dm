...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Basic Plasma Cutter",			/obj/item/gun/energy/plasmacutter,									3500, VENDING_WEAPON),
		new /datum/data/mining_equipment("Advanced Plasma Cutter",		/obj/item/gun/energy/plasmacutter/adv,								5000, VENDING_WEAPON),
		...
		new /datum/data/mining_equipment("KA Range Increase",			/obj/item/borg/upgrade/modkit/range,								300, VENDING_UPGRADE),
		new /datum/data/mining_equipment("KA Damage Increase",			/obj/item/borg/upgrade/modkit/damage,								300, VENDING_UPGRADE),
		new /datum/data/mining_equipment("KA Cooldown Decrease",		/obj/item/borg/upgrade/modkit/cooldown,								300, VENDING_UPGRADE),
		new /datum/data/mining_equipment("KA AoE Damage",				/obj/item/borg/upgrade/modkit/aoe/mobs,								750, VENDING_UPGRADE),
		...
		new /datum/data/mining_equipment("Ore Satchel of Holding",		/obj/item/storage/bag/ore/holding,									4000, VENDING_EQUIPMENT),
