...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("PS Cooldown Upgrade",			/obj/item/upgrade/plasmacutter/cooldown,							5000, VENDING_UPGRADE),
		new /datum/data/mining_equipment("PS Range Upgrade",			/obj/item/upgrade/plasmacutter/range,								5000, VENDING_UPGRADE),
