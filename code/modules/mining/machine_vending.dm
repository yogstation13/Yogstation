...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Point Transfer Card (1K)", 	/obj/item/card/mining_point_card/thousand,							1000, VENDING_MISC),
		new /datum/data/mining_equipment("Point Transfer Card (5K)", 	/obj/item/card/mining_point_card/fivethousand,						5000, VENDING_MISC),
		new /datum/data/mining_equipment("Point Transfer Card (10K)",	/obj/item/card/mining_point_card/tenthousand,						10000, VENDING_MISC),
