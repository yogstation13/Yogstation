...
/datum/map_template/shelter/New()
	. = ..()
	blacklisted_turfs = typecacheof(/turf/closed, /turf/open/lava/plasma/ice_moon/no_shelter, /turf/open/lava/smooth/lava_land_surface/no_shelter, /turf/open/water/deep_toxic_pit)
