...
/mob/proc/say_dead(var/message)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>DEAD:</span> <span class='name'>[name][(src.client.prefs.chat_toggles & GHOST_CKEY) ? "" : " ([K])" ]</span>[alt_name] <span class='message'>[emoji_parse(spanned)]</span></span>"
