/mob/living/simple_animal
	...
	var/list/atmos_requirements = list("min_oxy" = 0, "max_oxy" = 1, "min_tox" = 5, "max_tox" = 0, "min_co2" = 0, "max_co2" = 5, "min_n2" = 0, "max_n2" = 0) //Leaving something at 0 means it's off - has no maximum
