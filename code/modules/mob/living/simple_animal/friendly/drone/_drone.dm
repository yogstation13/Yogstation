...
/mob/living/simple_animal/drone
	...
	"3. Your goals are to build, maintain, repair, improve, and provide power to the best of your abilities, You must never actively work against these goals." //yogs - drones can leave the place they were created in
