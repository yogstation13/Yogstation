/mob/living/simple_animal/hostile/mushroom
	...
	var/powerlevel = FALSE //Tracks our general strength level gained from eating other shrooms
	var/bruised = FALSE //If someone tries to cheat the system by attacking a shroom to lower its health, punish them so that it wont award levels to shrooms that eat it
	var/recovery_cooldown = FALSE //So you can't repeatedly revive it during a fight
	var/faint_ticker = FALSE //If we hit three, another mushroom's gonna eat us
