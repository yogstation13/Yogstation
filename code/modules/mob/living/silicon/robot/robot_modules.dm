...
/obj/item/robot_module/detective/do_transform_animation()
	..()
	to_chat(loc, "<span class='userdanger'>While you have picked the detective module, you still have to follow your laws, NOT Space Law. \
	You are not a cyborg security officer.</span>")

/obj/item/robot_module/detective/respawn_consumable(mob/living/silicon/robot/R, coeff = 1)
	..()
