...
/datum/action/innate/ai/ranged/charge_borg_or_apc/InterceptClickOn(mob/living/caller, params, atom/clicked_on)
	. = ..()
	if(!.)
		return FALSE
	if(owner.incapacitated())
		unset_ranged_ability(owner, "You are incapacitated!")
		return FALSE
