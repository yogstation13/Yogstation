/mob/living/carbon
	...
	var/dreaming = FALSE //How many dream images we have left to send
...
//inventory slots
	...
	var/cpr_time = TRUE //CPR cooldown.
	var/damageoverlaytemp = 0

	var/drunkenness = FALSE //Overall drunkenness - check handle_alcohol() in life.dm for effects
	var/stam_regen_start_time = FALSE //used to halt stamina regen temporarily
