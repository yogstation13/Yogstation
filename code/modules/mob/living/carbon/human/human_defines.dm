/mob/living/carbon/human
	...
	var/static/list/can_ride_typecache = typecacheof(list(/mob/living/carbon/human, /mob/living/simple_animal/slime, /mob/living/simple_animal/parrot)) // What types of mobs are allowed to ride/buckle to this mob
	var/lastpuke = 0
