/datum/species/golem
	...
	name = "Golem"
	id = "iron golem"
	species_traits = list(NOBLOOD,MUTCOLORS, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT, NO_DNA_COPY, NOTRANSSTING)
...
/datum/species/golem/runic
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES,NOFLASH) //no mutcolors
	prefix = "Runic"
	special_names = null
...
/datum/species/golem/clockwork
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES,NOFLASH)
...
/datum/species/golem/cloth
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT) //no mutcolors, and can burn
...
/datum/species/golem/snow
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES) //no mutcolors, no eye sprites
	inherent_traits = list(TRAIT_NOBREATH,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_NOGUNS,TRAIT_RADIMMUNE,TRAIT_GENELESS,TRAIT_PIERCEIMMUNE,TRAIT_NODISMEMBER,TRAIT_NOHUNGER)
...
/datum/species/golem/bone
	...
	toxic_food = null
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES,NOFLASH,HAS_BONE)
	inherent_biotypes = MOB_UNDEAD|MOB_HUMANOID
...
/datum/species/golem/church_capitalist //slightly faster reskinned iron golem gained from a cult of st credit rite
	...
	limbs_id = "ca_golem"
	special_names = list("John D. Rockefeller","Rich Uncle Pennybags","Commodore Vanderbilt","Entrepreneur","Mr. Moneybags", "Adam Smith")
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES)
	fixed_mut_color = null
	speedmod = 1.5
	inherent_traits = list(TRAIT_RESISTHEAT,TRAIT_NOBREATH,TRAIT_RESISTCOLD,TRAIT_RESISTHIGHPRESSURE,TRAIT_RESISTLOWPRESSURE,TRAIT_NOFIRE,TRAIT_RADIMMUNE,TRAIT_GENELESS,TRAIT_PIERCEIMMUNE,TRAIT_NODISMEMBER,TRAIT_NOHUNGER)
...
/datum/species/golem/telecrystal
	...
	species_traits = list(NOBLOOD,MUTCOLORS, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOFLASH)
	prefix = "Telecrystal"
...
/datum/species/golem/ruinous //slightly weaker and faster,gets telepathy,speaks louder, and their text is cult colored
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT,NOEYESPRITES) //no mutcolors or eyesprites
...
/datum/species/golem/wax //has a love-hate relationship with fire
	...
	species_traits = list(NOBLOOD, NO_UNDERWEAR, NO_SOCKS, NO_UNDERSHIRT, NO_DNA_COPY, NOTRANSSTING, NOEYESPRITES) //no mutcolors or eyesprites
