/datum/species/polysmorph
	...
	species_traits = list(NOEYESPRITES, FGENDER, MUTCOLORS,HAIR, NOCOLORCHANGE)
	...
	mutant_bodyparts = list("tail_polysmorph", "dome", "dorsal_tubes", "teeth", "legs", "wings", "tail_human","tail_lizard", "ears")
	default_features = list("tail_polysmorph" = "Polys", "dome" = "None", "dorsal_tubes" = "No", "teeth" = "None", "legs" = "Normal Legs", "wings" = "none", "tail_human" = "none", "tail_lizard" = "none", "ears" = "None")
