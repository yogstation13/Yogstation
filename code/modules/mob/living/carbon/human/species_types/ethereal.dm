...
/datum/species/ethereal
	...
	species_traits = list(NOEYESPRITES, EYECOLOR, DYNCOLORS, AGENDER, NO_UNDERWEAR, HAIR, FACEHAIR, HAS_FLESH, HAS_BONE) // i mean i guess they have blood so they can have wounds too
