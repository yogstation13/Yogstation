...
/datum/species/monkey
	...
	knife_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/monkey = 5, /obj/item/stack/sheet/animalhide/monkey = 1)
	species_traits = list(
		NO_UNDERWEAR,
		LIPS,
		NOEYESPRITES,
	...
	no_equip = list(ITEM_SLOT_OCLOTHING, ITEM_SLOT_HANDS, ITEM_SLOT_FEET, ITEM_SLOT_SUITSTORE)
