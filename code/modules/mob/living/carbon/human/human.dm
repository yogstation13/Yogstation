...
/mob/living/carbon/human/show_inv(mob/user)
	...
	for (var/obj/item/bodypart/org in bodyparts)
		if (org.bandaged)
			dat += "<tr><td><i>[org.name]</i> wrapped with:</td><td><a href='byond://?src=\ref[src];unwrap=\ref[org.bandaged]'>[org.bandaged]</a></td></tr>" // yogs - show bandaged parts, side note: what the fuck is this proc?
