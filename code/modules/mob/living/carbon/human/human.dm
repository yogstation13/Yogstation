...
/mob/living/carbon/human/proc/fireman_carry(mob/living/carbon/target)
	...
	if(HAS_TRAIT(src, TRAIT_QUICKER_CARRY))
		...
		span_notice("[carrydelay < 3.5 SECONDS ? "Using your gloves' nanochips, you" : "You"][skills_space] start to lift [target] onto your back[carrydelay == 4 SECONDS ? ", while assisted by the nanochips in your gloves.." : "..."]")
