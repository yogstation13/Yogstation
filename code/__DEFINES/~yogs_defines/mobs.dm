...
#define PRETERNIS_FUELLEVEL_FULL 550
#define PRETERNIS_FUELLEVEL_WELL_FED 450
#define PRETERNIS_FUELLEVEL_FED 350
#define PRETERNIS_FUELLEVEL_HUNGRY 250
#define PRETERNIS_FUELLEVEL_STARVING 150
#define PRETERNIS_FUELLEVEL_NONE 0
