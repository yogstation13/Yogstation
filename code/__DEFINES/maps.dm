...
#define ZTRAIT_OCEAN_SURFACE "Ocean Surface" //Used in Undergruv to prevent smugglers satchel and other events spawning on a mostly empty z-level.
...
#define ZTRAIT_LAVAFLOOD "Weather_Lavaflood"
