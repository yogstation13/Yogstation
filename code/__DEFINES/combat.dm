...
///Coefficient of multiplication for the damage the item does when it falls out (this*item.w_class)
#define EMBEDDED_FALL_PAIN_MULTIPLIER			5	
...
#define EMBEDDED_UNSAFE_REMOVAL_PAIN_MULTIPLIER 8
