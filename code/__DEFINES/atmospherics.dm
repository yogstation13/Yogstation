...
#define ATMOS_EXTOOLS_CHECK if(!GLOB.atmos_extools_initialized){\
	...
	if(fexists(world.system_type == MS_WINDOWS ? "byond-extools.dll" : "byond-extools")){\
		var/result = call((world.system_type == MS_WINDOWS ? "byond-extools.dll" : "byond-extools"),"init_monstermos")();\
