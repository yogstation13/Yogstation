...
// The limit the human body can take before it starts taking damage from heat. This also affects how fast the body normalises it's temperature when hot.
/// 340k is about 66c, and rather high for a human.
#define BODYTEMP_HEAT_DAMAGE_LIMIT			(BODYTEMP_NORMAL + 30) 
// The limit the human body can take before it starts taking damage from coldness. This also affects how fast the body normalises it's temperature when cold.
