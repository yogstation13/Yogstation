...
#define AI_TEMP_LIMIT 288.15 //10C, much hotter than a normal server room for leniency :)
///Minimum temperature for all AI machinery
#define AI_TEMP_MINIMUM 273.15 //0C, sub zero minimum
