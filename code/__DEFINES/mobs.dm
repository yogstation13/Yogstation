...
//Skillsets, predefined lists of skills for mobs or ghost roles
GLOBAL_LIST_INIT(skillset_unskilled, list(
...
GLOBAL_LIST_INIT(skillset_basic, list(
	...
	SKILL_ROBOTICS = SKILLLEVEL_BASIC,
...
GLOBAL_LIST_INIT(skillset_trained, list(
	...
	SKILL_ROBOTICS = SKILLLEVEL_TRAINED,
...
GLOBAL_LIST_INIT(skillset_experienced, list(
	...
	SKILL_ROBOTICS = SKILLLEVEL_EXPERIENCED,
...
GLOBAL_LIST_INIT(skillset_master, list(
	...
	SKILL_ROBOTICS = SKILLLEVEL_MASTER,
