...
#define GRAB_PIXEL_SHIFT_PASSIVE (6*PIXEL_MULTIPLIER)
#define GRAB_PIXEL_SHIFT_AGGRESSIVE (12*PIXEL_MULTIPLIER)
#define GRAB_PIXEL_SHIFT_NECK (16*PIXEL_MULTIPLIER)
