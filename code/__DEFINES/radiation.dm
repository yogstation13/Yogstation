...
#define RAD_MINIMUM_CONTAMINATION 1000				// How strong does a radiation wave have to be to contaminate objects			// How strong does a radiation wave have to be to contaminate objects
