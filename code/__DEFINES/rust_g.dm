...
#define rustg_cnoise_generate(percentage, smoothing_iterations, birth_limit, _limit, width, height) \
	call(RUST_G, "cnoise_generate")(percentage, smoothing_iterations, birth_limit, _limit, width, height)
