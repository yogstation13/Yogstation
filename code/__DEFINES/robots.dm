...
/* phase this garbage out asap */
//Bot types
#define SEC_BOT_BIT				(1<<0)	// Secutritrons (Beepsky) and ED-209s
#define MULE_BOT_BIT			(1<<1)	// MULEbots
#define FLOOR_BOT_BIT			(1<<2)	// Floorbots
#define CLEAN_BOT_BIT			(1<<3)	// Cleanbots
#define MED_BOT_BIT				(1<<4)	// Medibots
#define HONK_BOT_BIT			(1<<5)	// Honkbots & ED-Honks
#define FIRE_BOT_BIT			(1<<6)  // Firebots
