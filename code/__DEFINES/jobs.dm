...
#define JOB_DISPLAY_ORDER_BLUESHIELD 3
#define JOB_DISPLAY_ORDER_HEAD_OF_SECURITY 4
#define JOB_DISPLAY_ORDER_WARDEN 5
#define JOB_DISPLAY_ORDER_SECURITY_OFFICER 6
#define JOB_DISPLAY_ORDER_DETECTIVE 7
