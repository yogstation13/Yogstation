...
#define JOB_DISPLAY_ORDER_RESEARCH_DIRECTOR 12
#define JOB_DISPLAY_ORDER_SCIENTIST 13
#define JOB_DISPLAY_ORDER_ROBOTICIST 14
#define JOB_DISPLAY_ORDER_NETWORK_ADMIN 15
