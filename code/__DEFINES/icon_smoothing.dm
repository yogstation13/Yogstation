...
//TODO INCREASE IT ALL BY ONE

#define SMOOTH_GROUP_CARPET_ROYAL_PURPLE S_TURF(20) ///turf/open/indestructible/carpet/royal/purple
...
#define SMOOTH_GROUP_BAMBOO_FLOOR S_TURF(53) //![/turf/open/floor/bamboo]
#define SMOOTH_GROUP_BRAZIL S_TURF(54) ///turf/open/indestructible/brazil/lostit
...
#define SMOOTH_GROUP_SYNDICATE_WALLS S_TURF(56) ///turf/closed/wall/r_wall/syndicate, /turf/closed/indestructible/syndicate
...
#define SMOOTH_GROUP_BOSS_WALLS S_TURF(59) ///turf/closed/indestructible/riveted/boss
#define SMOOTH_GROUP_SURVIVAL_TITANIUM_WALLS S_TURF(60) ///turf/closed/wall/mineral/titanium/survival
#define SMOOTH_GROUP_TURF_OPEN_CLIFF S_TURF(61) ///turf/open/cliff
#define SMOOTH_GROUP_TURF_BALLPIT S_TURF(62) ///turf/open/floor/ballpit
