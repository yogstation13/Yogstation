...
#define COMSIG_KINETIC_CRUSHER_PROJECTILE_ON_RANGE "kinetic_crusher_projectile_on_range" 				// from base of /obj/item/projectile/destabilizer/on_range():
																										// (mob/user, /obj/item/twohanded/kinetic_crusher/hammer_synced)
#define COMSIG_KINETIC_CRUSHER_PROJECTILE_FAILED_TO_MARK "kinetic_crusher_projectile_failed_to_mark"	// from base of /obj/item/projectile/destabilizer/on_hit(): 
																										//(mob/user, /obj/item/twohanded/kinetic_crusher/hammer_synced)
