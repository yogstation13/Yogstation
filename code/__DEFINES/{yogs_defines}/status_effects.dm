...
#define STATUS_EFFECT_BERSERKER /datum/status_effect/berserker //granted by using the berserker spell, makes you more resistant to stuns and damage slowdown, but makes you mute and deaf