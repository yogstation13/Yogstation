...
/mob/living/silicon/ai/ClickOn(var/atom/A, params)
	...
	if(!can_see(A))
		...
		to_chat(src, "<span class='reallybig'>You have been automatically kicked because you clicked a turf you shouldnt of been able to see as an AI. You should reconnect automatically. If you do not, you can reconnect using the File --> Reconnect button.</span>")
