...
#define MAX_SAFE_BYOND_ICON_SCALE_TILES (MAX_SAFE_BYOND_ICON_SCALE_PX / WORLD_ICON_SIZE)
#define MAX_SAFE_BYOND_ICON_SCALE_PX (33 * 32)			//Not using WORLD_ICON_SIZE on purpose.

/obj/screen/click_catcher/proc/UpdateGreed(view_size_x = 15, view_size_y = 15)
	var/icon/newicon = icon('icons/mob/screen_gen.dmi', "catcher")
	var/ox = min(MAX_SAFE_BYOND_ICON_SCALE_TILES, view_size_x)
	var/oy = min(MAX_SAFE_BYOND_ICON_SCALE_TILES, view_size_y)
	var/px = view_size_x * WORLD_ICON_SIZE
	var/py = view_size_y * WORLD_ICON_SIZE
